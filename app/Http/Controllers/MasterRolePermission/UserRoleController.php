...
class UserRoleController extends MasterRolePermissionController
{
    ...
    public function updateRole(Request $request)
    {
        ...
        if(!$getUpdateRole)
        {    
            return redirect()->route('CreateUserRole')->with('error_message','Sorry, we cannot update this Role, Try again');
        }
        return redirect()->route('AllRole')->with('message','Role Successfully Updated');
    }
