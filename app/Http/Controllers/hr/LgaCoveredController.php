...
class LgaCoveredController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['State'] = $aState;
        return view('hr.lga.lgacovered', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($reallyStore) {
            ...
            return redirect('lga/covered')->with('success', 'Local Government Area is successfully added!');
        } else {
    ...
    public function update(Request $request)
    {
        ...
        return redirect('lga/covered')->with('success', 'Local Government Area successfully updated!');
    }
    ...
    public function destroy($lgaId)
    {
        ...
        if ($lgaExists) {
            ...
            return redirect('lga/covered')->with('success', 'Local Government Area successfully deleted!');
        }
    }
}
