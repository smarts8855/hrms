...
{
    return view('payroll.coverletter.select');
}
...
public function view(Request $request)
{
    ...
    //dd($fractions);
    return view('payroll.coverletter.create',$data);

}

public function council()
{
    return view('payroll.coverletter.council');
}
...
public function councilview(Request $request)
{
    ...
    //dd($fractions);
    return view('payroll.coverletter.council_view',$data);
