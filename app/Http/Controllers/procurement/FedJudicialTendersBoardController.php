...
class FedJudicialTendersBoardController extends Controller
{
    ...
    public function display()
    {
        $data['contract'] = DB::table('tblcontract_details')
            ...
            ->where('tblcontract_bidding.current_location', '=', 5)
            ->groupBy('tblcontract_bidding.contractID')
            ->orderBy('contract_detailsID')->get();
        return view('procurement.TendersBoard.contractsFedTenders', $data);
    }
    ...
    public function searchContract(Request $request)
    {
        ...
        return view('TendersBoard.contractsFedTenders', $data);
    }
