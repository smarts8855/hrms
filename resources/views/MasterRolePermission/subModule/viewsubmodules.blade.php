                    ...
                    <div class="wrap">
                        <div class="search">
                            ...
                            <input type="text" id="autocomplete_central" name="q" class="form-control"
                                placeholder="Search By Name or File No." style="padding: 5px; width: 300px;">
                            <!--searchTerm-->
        ...
        <div class="col-md-12">
            <table class="table table-striped table-condensed table-bordered input-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        @if ($submodules instanceof \Illuminate\Pagination\LengthAwarePaginator)
                        ...
                        <td><a href="{{url('/sub-module/edit/'.$list->submoduleID)}}" title="Edit"
                                class="btn btn-success fa fa-edit"></a></td>
                        <td> <button type="button" data-toggle="modal" data-target="#delete{{$list->submoduleID}}"
            ...
            <div align="right">
                ...
                to {{ min($submodules->currentPage() * $submodules->perPage(), $submodules->total()) }}
                of {{ $submodules->total() }} entries
            </div>
            <div class="hidden-print">{{ $submodules->links() }}</div>
            @else
            <div align="right">
                Showing {{ $submodules->count() }} entries
            </div>
            @endif
        </div>
    </div><!-- /.col -->
