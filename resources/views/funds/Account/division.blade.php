	...
	<form method="post"  id="thisform1" name="thisform1">
		...
		<div class="box-body">
			 <div class="row">
	            		<div class="col-md-2">
	            		<label>Court</label>
				<select name="court" id="court" class="form-control" required onchange="ReloadForm();">
					...
					<input type="text"  name="division"  class="form-control"  value="{{$division}}" placeholder="Enter New Division">
	            		</div>
					...
					<th >Action</th>
						...
						@foreach ($DivisionList as $b)
							...
							<td>{{ $serialNum ++}} </td>
								...
								<td><a href="javascript: DeletePromo('{{$b->divisionID}}')">Delete</a></td>	
							</tr>
						@endforeach
