        ...
        {{ csrf_field() }}
          <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                @if(file_exists("/home/njcgov/funds.njc.gov.ng".$b->filename))
        ...
        <div class="col-md-12">
          <div class="form-group">
            ...
            <div class="col-md-4">
                ...
                <input type="hidden" class="form-control" id="allocationtype1" name="allocationtype1" placeholder="" readonly value="5" >
            </div>
            ...
            <tr class="input-lg">
              ...
              <tbody>
                ...
                <th>
                  ...
                  <option value="20" {{($prempercentage == 20 || 20 == old('prempercentage')) ? "selected" : ""}}>20%</option>
                ...
                <th><span class="hidden-print">
                  <input type="text" id="prem" value="{{($prem) ? $prem : old('prem')}}" name="prem" readonly class="form-control" style="border: none; background: white" ></span>
                </th>
                </tr>
                <tr class="input-lg">
                <th class="text-center"><span class="hidden-print">&#10004;</span></th>
