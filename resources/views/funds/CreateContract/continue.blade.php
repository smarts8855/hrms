            ...
            <div class="box-header with-border hidden-print">
                <div class="row">
                    ...
                    <div class="col-xs-6 text-right">
                        <a href="/display/comment/{{ $contractID }}" target="_blank" class="btn btn-primary btn-sm">
                            <i class="fa fa-comment-o"></i> View Comment
                        </a>
                        <a href="{{ URL::previous() }}">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        @foreach ($fileattach as $b)
                                            @if ($b->filename)
                                                <a href="{{ $b->filename }}" target="_blank"
                                                    class="label label-danger custom-label"
                                                    style="margin-right: 5px; display: inline-block;">
                                                    <i class="fa fa-download"></i> {{ $b->file_desc }}
                                                </a>
                                            @endif
                                        @endforeach
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        @php
                                            ...
                                            $old = old('totalamount');
                                        @endphp
                                        <label class="control-label"><small>Enter Sum Total Amount if making part
                                                payment</small></label>
                                        <input type="text" class="form-control" readonly id="totalamount"
                                            value="{{ number_format($getBalance ? $getBalance : $old) }}"
                                            name="totalamount" placeholder="Enter total amount (Optional)">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select onchange="return getEconomics()" class="form-control" id="contracttype"
                                            name="contracttype">
                                        ...
                                        <input type="hidden" class="form-control" id="allocationtype1"
                                            name="allocationtype1" placeholder="" readonly value="5">
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        @if ($economicCode_as != '')
                                            <input type="text" class="form-control" readonly
                                                value="{{ $econ3 }}">
                                            <input type="hidden" name="economicCode1" id="economicCode1"
                                                class="form-control" readonly value="{{ $economicCode_as }}">
                                        @else
                                            <select name="economicCode1" id="economicCode1" class="form-control">
                                                ...
                                                @foreach ($ECONOMAIN as $list)
                                                    <option value="{{ $list->ID }}"
                                                        @if (old('economicCode1') == $list->ID) {{ 'selected' }} @endif>
                                                        ({{ $list->description }})
                                                        {{ $list->economicCode }}</option>
                                                @endforeach
                                            </select>
                                        @endif
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <table class="table table-striped table-condensed table-bordered ">
                                <thead style="background: #fdfdfd;">
                                    <tr class="input-lg">
                                        ...
                                        <th width="600" rowspan="2" class="text-center">
                                            @if ($companyidhid != 13)
                                                Contractor Detail
                                            @else
                                                Beneficiary
                                ...
                                <tbody>
                                    <tr class="input-lg">
                                        ...
                                        <th>
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <input type="text" name="beneficiaryName" readonly
                                                        id="beneficiaryName" class="form-control hidden-print "
                                                        style="border:1px solid #333;"
                                                        value="{{ $contractor ? $contractor : old('beneficiaryName') }}"
                                                        placeholder="Beneficiary Name">
                                                    <input type="hidden" name="companyid"
                                                        value="{{ $companyidhid ? $companyidhid : old('companyid') }}">
                                                </div>
                                        ...
                                        <th>
                                            ...
                                            @endphp
                                            <span class="">
                                                <input type="text" onchange="calc()" onkeyup="calc()" name="amount"
                                                    id="netAmount" class="form-control " autocomplete="off"
                                                    placeholder="Gross Amount" value="{{ $mone }}">
                                    ...
                                    @if ($companyidhid != 13)
                                        <tr class="input-lg" style="display: none;">
                                            <th class="text-center"><span class="hidden-print">&#10004;</span></th>
                                            <th>
                                                <span class="hidden-print">
                                                    <select name="prempercentage" id="prempercentage"
                                                        class="form-control hidden-print "
                                                        style="border: none; width: 15%; float: left;"
                                                        value="{{ old('prempercentage') }}">

                                                        <option value="0">N/A</option>
                                                        <option value="12.5"
                                                            {{ $prempercentage == 12.5 || 12.5 == old('prempercentage') ? 'selected' : '' }}>
                                                            12.5%</option>
                                                        <option value="20"
                                                            {{ $prempercentage == 20 || 20 == old('prempercentage') ? 'selected' : '' }}>
                                                            20%</option>
                                            ...
                                            <th><span class="hidden-print">
                                                    <input type="text" id="prem"
                                                        value="{{ $prem ? $prem : old('prem') }}" name="prem" readonly
                                                        class="form-control"
                                                        style="border: none; background: white"></span>
                                            </th>
                                        </tr>
                                        ...
                                        <tr class="input-lg">
                                            ...
                                            <th>
                                                <span class="hidden-print">
                                                    <select name="vatselect" id="vatselect"
                                                        class="form-control hidden-print "
                                                        style="border: none; width: 15%; float: left;"
                                                        value="{{ old('vatselect') }}">
                                                        ...
                                                        <option value="0">N/A</option>
                                                        {{-- <option value="5"
                                                            {{ $vatpas == 5 || 5 == old('vatselect') ? 'selected' : '' }}>
                                                            5%</option> --}}
                                                        <option value="7.5"
                                                            {{ $vatpas == 7.5 || 7.5 == old('vatselect') ? 'selected' : '' }}>
                                                            7.5%</option>
                                                        {{-- <option value="10"
                                                            {{ $vatpas == 10 || 10 == old('vatselect') ? 'selected' : '' }}>
                                                            10%</option> --}}
                                            ...
                                            <th><span class="hidden-print">
                                                    <input type="text" id="vat"
                                                        value="{{ $vatvas ? $vatvas : old('vat') }}" name="vat"
                                        ...
                                        <tr class="input-lg">
                                            <th class="text-center"><span class="hidden-print">&#10004;</span></th>
                                            <th> <span class="hidden-print">
                                                    <select name="whtOrTax" id="WithholdingTax"
                                                        class="form-control hidden-print" value="{{ old('whtOrTax') }}"
                                                        style="border: none; width: 15%; float: left;">
                                                        <option value="0" selected="selected">N/A</option>
                                                        <option value="2"
                                                            {{ $whtpas == 2 || 2 == old('whtOrTax') ? 'selected' : '' }}>
                                                            2%</option>
                                                        <option value="5"
                                                            {{ $whtpas == 5 || 5 == old('whtOrTax') ? 'selected' : '' }}>
                                                            5%</option>
                                                        {{-- <option value="7.5"
                                                            {{ $whtpas == 7.5 || 7.5 == old('whtOrTax') ? 'selected' : '' }}>
                                                            7.5%</option> --}}
                                                        <option value="10"
                                                            {{ $whtpas == 10 || 10 == old('whtOrTax') ? 'selected' : '' }}>
                                                            10%</option>
                                                    </select> &nbsp; Withholding Tax Payable &#60; Cash Book &#62;
                                                </span>
                                            </th>
                                            <th></th>
                                            <th><span class="hidden-print">
                                                    <input type="text" id="tax" name="tax"
                                                        value="{{ $whtvas ? $whtvas : old('tax') }}" class="form-control"
                                        ...
                                        <tr class="input-lg">
                                            ...
                                            <th>
                                                <span class="hidden-print">
                                                    <select name="stampduty" id="stampduty"
                                                        class="form-control hidden-print "
                                                        style="border: none; width: 15%; float: left;"
                                                        value="{{ old('stampduty') }}">
                                                        ...
                                                        <option value="0">N/A</option>
                                                        <option value="1"
                                                            {{ $stampduty == 1 || 1 == old('stampduty') ? 'selected' : '' }}>
                                                            1%</option>
                                            ...
                                            <th></th>
                                            <th><span class="hidden-print">
                                                    <input type="text" id="stampdutyval"
                                                        value="{{ $stampdutyval ? $stampdutyval : old('stampdutyval') }}"
                                                        readonly class="form-control"
                                                        style="border: none; background: white"></span>
                                            </th>
                                        </tr>
                                    ...
                                    <tr class="input-lg">
                                        <th class="text-center"><span class="hidden-print">&#10004;</span></th>
                                        <th><span class="hidden-print">Amount Payable to individual/contractor &#60;
                                                Cash
                                                Book &#62; </span> </th>
                                        <th></th>
                                        <th>
                                            <div class="hidden-print" id="grossAmount"
                                                style="border-bottom: 1px solid #000;">
                                                {{ $amtpayble ? $amtpayble : old('amtpayable') }}</div>
                                        </th>
                                    </tr>
                                    <tr class="input-lg">
                                        <th></th>
                                        ...
                                        <input type="hidden" name="amtpayable"
                                            value="{{ $amtpayble ? $amtpayble : old('amtpayable') }}" id="amtpayable">
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="table table-striped table-condensed">
                                <thead style="background: #fff;">
                                    @if ($companyidhid != 13)
                                        <tr class="input-lg hidden-print">
                                            ...
                                            <th width="600">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <select disabled name="vatPayeeID" class="form-control"
                                                            id="vatPayeeID" onchange="return getAddrvat()"
                                                            style="border: 1px thin #f9f9f9;">
                                                            <option value="">select</option>
                                                            @foreach ($vatwhttable as $list)
                                                                <option value="{{ $list->ID }}"
                                                                    {{ $list->ID == $vatpayeeas || $list->ID == old('vatPayeeID') ? 'selected' : '' }}>
                                                                    {{ $list->payee }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                        ...
                                        <tr class="input-lg hidden-print">
                                            ...
                                            <th width="600">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <select disabled name="whtPayeeID" id="whtPayeeID"
                                                            class="form-control" onchange="return getAddrwht()"
                                                            style="border: 1px thin #f9f9f9;">
                                                            <option value="">select</option>
                                                            @foreach ($vatwhttable as $list)
                                                                <option value="{{ $list->ID }}"
                                                                    {{ $list->ID == $whtpayeeas || $list->ID == old('whtPayeeID') ? 'selected' : '' }}>
                                                                    {{ $list->payee }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                    ...
                                    <tr class="input-lg">
                                        ...
                                        <th width="600">
                                            <input type="hidden" name="paymentdesc"
                                                value="{{ $paymentdesc ? $paymentdesc : old('paymentdesc') }}">
                                            <textarea name="narration" class="form-control input-lg hidden-print"
                                                style="border: 1px thin #f9f9f9; height: 100px;">{{ $paymentdesc ? $paymentdesc : old('narration') }}</textarea>
                                        </th>
                                    </tr>
                                    ...
                                    <tr class="input-lg">
                                        ...
                                        <th><input type="text" name="filenoas" class="form-control hidden-print"
                                                readonly style="border: 1px thin #f9f9f9;"
                                                value="{{ $filenoas ? $filenoas : old('fileno') }}"></th>
                                    </tr>
                                    ...
                                    <tr class="input-lg">
                                        ...
                                        <th><input type="text" name="preparedBy" readonly="readonly"
                                                class="form-control hidden-print" style="border: 1px thin #f9f9f9;"
                                                value="{{ $currentuser ? $currentuser : old('preparedBy') }}"></th>
                                    </tr>
                                    ...
                                    <tr class="input-lg">
                                        ...
                                        <th><span class="hidden-print">
                                                <input readonly type="text"
                                                    value="{{ $todayDateas ? $todayDateas : old('todayDate') }}"
                                                    readonly="readonly" name="todayDate" id="todayDate"
                                                    class="form-control col-lg-4" placeholder="Select Date">
                                            </span></th>
                                    </tr>
                            ...
                            <center><button class="btn btn-success" onclick="return submitVoucher()">Create
    ...
    <script>
        ...
        $("#vatselect ,#WithholdingTax,#stampduty,#prempercentage").change(function() {
            ...
            if (amount == "") {
                ...
                if (premval > 0.001) {
                    var vat = (vat_rate / demo) * premval;
                    var mockval = premval - vat;
