                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" role="form" id="form1" method="post" action="">
                                    ...
                                    <div class="col-md-12"><!--2nd col-->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select onchange="return getEconomics()" class="form-control"
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select onchange="return getEconomics()" class="form-control"
                                                    id="allocationtype" name="allocationtype" placeholder="">
                                                    <option value="">Select Allocation</option>
                                                    @foreach ($allocationlist as $list)
                                                        <option value="{{ $list->ID }}"
                                                            {{ $list->ID == $allocationtype ? 'selected' : '' }}>
                                                            {{ $list->allocation }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                ...
                                <div align="center">
                                    <h3><b>
                                            <div>{{ strtoupper('VOUCHER ENTRY') }}</div>
                                        </b></h3>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                            ...
                                            <tbody>
                                                <tr class="input-lg">
                                                    ...
                                                    <th>
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <input type="text" readonly id="beneficiaryName"
                                                    ...
                                                    <th>
                                                        <span class="hidden-print">
                                                            <input type="text" onchange="calc()" onkeyup="calc()"
                                                                name="amount" id="netAmount" class="form-control "
                                                                autocomplete="off" placeholder="Gross Amount"
                                                                value="{{ $amount }}">
                                                ...
                                                @if ($companyid != 13)
                                                    <tr class="input-lg" style="display: none">
                                                        <th class="text-center"><span class="hidden-print">&#10004;</span>
                                                        </th>
                                                        <th>
                                                            <span class="hidden-print">
                                                        ...
                                                        <th><span class="hidden-print">
                                                                <input type="text" id="prem"
                                                                    value="{{ number_format($prem ? $prem : old('prem'), 2) }}"
                                                                    name="prem" readonly class="form-control"
                                                        ...
                                                        <th>
                                                            <span class="hidden-print">
                                                                <select name="vatselect" id="vatselect"
                                                                    ...
                                                                    value="{{ old('vatselect') }}">
                                                                    <option value="0"
                                                                        {{ $vatselect == 0 ? 'selected' : '' }}>N/A
                                                                    </option>
                                                                    {{-- <option value="5"
                                                                        {{ $vatselect == 5 ? 'selected' : '' }}>5%</option> --}}
                                                                    <option value="7.5"
                                                                        {{ $vatselect == 7.5 ? 'selected' : '' }}>7.5%
                                                                    </option>
                                                                    {{-- <option value="10"
                                                                        {{ $vatselect == 10 ? 'selected' : '' }}>10%
                                                                    </option> --}}
                                                    ...
                                                    <tr class="input-lg">
                                                        ...
                                                        <th> <span class="hidden-print">
                                                                <select name="whtOrTax" id="WithholdingTax"
                                                                    ...
                                                                    style="border: none; width: 15%; float: left;">
                                                                    <option value="0"
                                                                        {{ $whtOrTax == 0 ? 'selected' : '' }}>N/A</option>
                                                                    <option value="2"
                                                                        {{ $whtOrTax == 2 ? 'selected' : '' }}>2%</option>
                                                                    <option value="5"
                                                                        {{ $whtOrTax == 5 ? 'selected' : '' }}>5%</option>
                                                                    {{-- <option value="7.5"
                                                                        {{ $whtOrTax == 7.5 ? 'selected' : '' }}>7.5%
                                                                    </option> --}}
                                                                    <option value="10"
                                                                        {{ $whtOrTax == 10 ? 'selected' : '' }}>10%
                                                                    </option>
                                                        ...
                                                        <th></th>
                                                        <th><span class="hidden-print">
                                                                <input type="text" id="tax" name="wht"
                                                                    value="{{ $wht }}" class="form-control"
                                                    ...
                                                    <tr class="input-lg">
                                                        ...
                                                        <th> <span class="hidden-print">
                                                                <select name="stampduty" id="stampduty"
                                                                    ...
                                                                    style="border: none; width: 15%; float: left;">
                                                                    <option value="0"
                                                                        {{ $stampduty == 0 ? 'selected' : '' }}>N/A
                                                                    </option>
                                                                    <option value="1"
                                                                        {{ $stampduty == 1 ? 'selected' : '' }}>1%</option>
                                                                </select> &nbsp; Stamp duty Payable &#60; Cash Book &#62;
                                                            </span> </th>
                                                        <th></th>
                                                        <th><span class="hidden-print">
                                                                <input type="text" id="stampdutyval"
                                                                    name="stampdutyval" value="{{ $stampdutyval }}"
                                                                    class="form-control"
                                                                    style="border: none; background: #f9f9f9">
                                                            </span>
                                                        </th>
                                                ...
                                                @else
                                                    ...
                                                    <input type="hidden" id="WithholdingTax" name="whtOrTax"
                                                        value="0">
                                                    <input type="hidden" id="vat" name="vat" value="0">
                                                    <input type="hidden" id="vatselect" name="vatselect"
                                                        value="0">
                                                @endif
                                                <tr class="input-lg">
                                                    <th class="text-center"><span class="hidden-print">&#10004;</span>
                                                    ...
                                                    <th>
                                                        <div class="hidden-print" id="grossAmount"
                                                            style="border-bottom: 1px solid #000;">{{ $amtpayable }}
                                                        </div>
                                                    </th>
                                                </tr>
                                                <tr class="input-lg">
                                                    ...
                                                    <input type="hidden" name="amtpayable" value="{{ $amtpayable }}"
                                                        id="amtpayable">
                                                </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <table class="table table-striped table-condensed">
                                            <thead style="background: #fff;">
                                                @if ($companyid != 13)
                                                    <tr class="input-lg hidden-print">
                                                        ...
                                                        <th>
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <select disabled id="vatPayeeID" name="vatPayeeID"
                                                                        class="form-control"
                                                                        style="border: 1px thin #f9f9f9;">
                                                                        <option value="">select</option>
                                                                        @foreach ($vatwhttable as $list)
                                                                            <option value="{{ $list->ID }}"
                                                                                {{ $list->ID === $vatPayeeID ? 'selected' : '' }}>
                                                                                {{ $list->payee }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                    ...
                                                    <tr class="input-lg hidden-print">
                                                        ...
                                                        <th>
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <select disabled id="whtPayeeID" name="whtPayeeID"
                                                                        class="form-control"
                                                                        style="border: 1px thin #f9f9f9;">
                                                                        <option value="">select</option>
                                                                        @foreach ($vatwhttable as $list)
                                                                            <option value="{{ $list->ID }}"
                                                                                {{ $list->ID === $whtPayeeID ? 'selected' : '' }}>
                                                                                {{ $list->payee }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                ...
                                                @else
                                                    <input type="hidden" id="whtPayeeID" name="whtPayeeID"
                                                        value="0">
                                                    <input type="hidden" id="vatPayeeID" name="vatPayeeID"
                                                        value="0">
                                                @endif
                                                <tr class="input-lg">
                                                    ...
                                                    <th width="600">
                                                        ...
                                                        <textarea name="narration" class="form-control input-lg hidden-print"
                                                            style="border: 1px thin #f9f9f9; height: 100px;">{{ $narration }}</textarea>
                                                    </th>
                                                </tr>
                                                ...
                                                <tr class="input-lg">
                                                    ...
                                                    <th><input type="text" name="fileno" readonly
                                                            class="form-control hidden-print"
                                                            style="border: 1px thin #f9f9f9;"
                                                            value="{{ $fileno }}">
                                                    </th>
                                        ...
                                        <center><button class="btn btn-success" onclick="return submitVoucher()">Save
