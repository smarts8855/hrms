...
@section('pageTitle')
    {{ strtoupper('Assigned Advance Vouchers') }}
@endsection
@section('content')
                                                ...
                                                @foreach ($tablecontent as $list)
                                                    @if ($list->contractBalance != 0)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="dropdown">
                                                                    ...
                                                                    <ul class="dropdown-menu"
                                                                        ...
                                                                        <li><a
                                                                                onclick="setID('{{ encrypt($list->ID) }}')">Process</a>
                                                                        </li>
                                                                        <li><a
                                                            ...
                                                            @php
                                                                $list->contractValue = (int) $list->contractValue;
                    ...
                    <form class="form-horizontal" role="form" method="post" action="/return/contract">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <h5> You are about to return this document back to the last officer! Do you still want
                                        to continue?</h5>
                                    <div class="form-group" style="margin: 0 10px;">
                                        <div class="col-sm-12">
