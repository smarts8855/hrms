...
@section('content')
    ...
    <div class="box box-default">
        <div class="box-body box-profile">
            ...
            <div class="box-body">
                <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <textarea id="content" rows="5" cols="80" class="form-control" name="details" required> {{ $claimdetails }}</textarea>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            @if ((!$transID) && ($claimid))
                            <center><button class="btn btn-success" type= "submit" name= "continue">Continue</button>
                            </center>
                            @endif
            ...
            @if ($transID && $claimid)
            <center><a href="/display/voucher/{{ $transID }}/{{$claimid}}" target="_blank" class="btn btn-info">View voucher</a>
            </center>
            @endif
            <hr />
        </div>
