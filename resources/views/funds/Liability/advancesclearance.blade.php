...
@section('pageTitle')
    Refer to Head Expenditure Control
@endsection
            ...
            <div class="modal-content">
                ...
                <form class="form-horizontal" role="form" method="POST" action="">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group" style="margin: 0 10px;">
                            <h4 class="modal-title">You are about to pass the voucher to the expenditure control. Do you
                                    ...
                                    @if ($tablecontent)
                                        @foreach ($tablecontent as $list)
                                            <tr
                                                ...
                                                <td>{{ ++$i }}</td>
                                                <td> SCN/ADV/{{ $list->vref_no }}/{{ $list->period }}</td>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                                            ...
                                                            <li><a onclick="decline('{{ $list->ID }}')">Archive</a>
                                                            </li>
