                                ...
                                <tbody>
                                    @if ($tablecontent)
                                        @foreach ($tablecontent as $list)
                                            <tr
                                                @if ($list->isrejected == 1) style="background-color: red; color:#FFF;" @elseif($list->is_retired == 1)style="background-color: green; color:#FFF;" @endif>
                                                <td>{{ $i++ }}</td>
                                                <td>
                                                    <div class="dropdown">
                                                ...
                                                <td>{{ $list->statusdesc }} @if ($list->is_retired == 1)
                                                        Retired
                                                    @else
                                                        Not Retired
                                                    @endif
