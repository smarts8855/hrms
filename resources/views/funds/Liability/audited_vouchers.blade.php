                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input type="text" class="col-sm-9 form-control" value="{{ formatDate($fromdate) }}"
                                                name="fromdate" id="fromdate">
                                        </div>
                                        <div class="col-md-2">
                                            <label class="control-label">Date To</label>
                                            <input type="text" class="col-sm-9 form-control" value="{{ formatDate($todate) }}"
                                    ...
                                    @if ($tablecontent)
                                        @foreach ($tablecontent as $list)
                                            <tr @if ($list->isrejected == 1) style="background-color: red; color:#FFF;" @endif
                                                ...
                                                <td>{{ formatDate($list->auditDate) }}</td>
                                                <td>{{ $list->name }}</td>
                                            </tr>
                                        @endforeach
                                    @else
