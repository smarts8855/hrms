        ...
        {{ csrf_field() }}
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    ...
                    <input extarea required class="form-control" id="fileno" placeholder="e.g FHC/XXXX"  name="fileno" value="" >
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <textarea required class="form-control" id="contract-desc"  name="contract-desc"></textarea>
                </div>

                <div class="col-md-3">
                    <label class="control-label">Contract Value</label>
                    <input required class="form-control" id="contractvalue" value="" placeholder="e.g. N100000" name="contractvalue">
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    ...
                    <input required class="form-control" id="todayDate" autocomplete="off" name="date_awarded" value="">
                </div>

                <div class="col-md-4">
                    <label class="control-label">Created By</label>
                    <input required class="form-control" id="createdby" value=""  readonly name="createdby">
                </div>
            </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <div class="dropdown">
                                      ...
                                      @if($list->checkbyStatus == 0)
                                        ...
                                        <li><a onclick="comments('{{$list->comment}}')" >View Comments</a></li>
                                        @php
                                    ...
                                    <td>
                                        @if($list->liabilityStatus == 0)
                                            <span class="text-danger">Not Accepted</span>
                                        @elseif($list->liabilityStatus == 2)
