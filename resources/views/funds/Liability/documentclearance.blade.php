            ...
            <div class="modal-content">
                ...
                <form class="form-horizontal" role="form" method="POST" action="">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group" style="margin: 0 10px;">
                            <h4 class="modal-title">You are about to pass the voucher for further processing. Do you really
                                want to continue?</h4>
                            <div class="col-sm-12">
                                    ...
                                    @if ($tablecontent)
                                        @foreach ($tablecontent as $list)
                                            <tr
                                                ...
                                                <td>{{ ++$i }}</td>
                                                <td> NJC/OC/{{ $list->vref_no }}/{{ $list->period }}</td>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                                            <li><a onclick="accept('{{ $list->ID }}')">Clear</a></li>
                                                            <li><a onclick="decline('{{ $list->ID }}')">Refer to
                                                                    CA</a></li>
