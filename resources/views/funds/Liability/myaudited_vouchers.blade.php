...
@section('pageTitle')
List of vouchers audited by me
@endsection
@section('content')
	...
	<div class="col-md-12">
		<div class="form-group">
			...
			<div class="col-md-2">          
		      ...
		      <input type="text" class="col-sm-9 form-control" value="{{$fromdate}}" name="fromdate" id="fromdate">
		    </div>
			<div class="col-md-2">          
				<label class="control-label">Date To</label>
				<input type="text" class="col-sm-9 form-control" value="{{$todate}}" name="todate" id="todate">
			</div>
		</div>
