                                                ...
                                                @foreach ($tablecontent as $list)
                                                    <tr @if ($list->isrejected == 1) style="background-color: red; color:#FFF;" @endif
                                                        ...
                                                        @if ($list->voucherType == '1')
                                                            <td>{{ $list->contractor }}<br>
                                                            Date Prepared: {{ $list->datePrepared }} <br>
                                                            Date Awarded: {{ $list->dateAward }}
                                                            </td>
                                                        @else
                                                            <td>{{ $list->payment_beneficiary }}<br>
                                                            Date Prepared: {{ $list->datePrepared }} <br>
                                                            Date Awarded: {{ $list->dateAward }}
                                                            </td>
                                                        @endif
                                                        ...
                                                        <td>
                                                            @if ($list->voucher_lock < 1)
                                                                <div class="dropdown">
                                                                    ...
                                                                    <ul class="dropdown-menu"
                                                                        ...
                                                                        <li>
                                                                            <a
                                                                                onclick="accept('{{ $list->ID }}')">Process</a>
                                                                        </li>
                                                                        <li>
                                                                            <a
                                                                                onclick="decline('{{ $list->ID }}')">Decline</a>
                                                                        </li>
                                                                        <li>
                                                                            <a target ="_blank"
                                                                        ...
                                                                        <li>
                                                                            <a href="/display/comment/{{ $list->conID }}"
                                                                                target="_blank">View Minutes</a>
                                                                        </li>
                                                                        <li>
                                                                            <a
                                                                                onclick="documentQuery('{{ $list->ID }}')">Query
                                                                                Documents</a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            @else
                                                                <a target ="_blank"
                                                                    href="/display/voucher/{{ $list->ID }}"
                                                                    class="btn btn-default btn-xs"
                                                                    tile="Please contact your admin.">Preview</a>
                                                            @endif
                                                        </td>
                                                        <td>
                                                            @if ($list->voucher_lock < 1)
                                                                <select class="form-control" id="staff{{ $list->ID }}">
                                                                    ...
                                                                    @foreach ($UnitStaff as $list2)
                                                                        <option value="{{ $list2->user_id }}"
                                                                            {{ $list->auditedBy == $list2->user_id ? 'selected' : '' }}>
                                                                            {{ $list2->Names }}</option>
                                                                    @endforeach
                                                                </select>
                                                            @else
