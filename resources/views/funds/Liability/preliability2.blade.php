...
@section('pageTitle')
    Expenditure Control: Funds Clearance
@endsection
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                                                ...
                                                                <li><a onclick="accept('{{ $list->ID }}','{{ $list->economicCodeID }}')"
                                                                        href="#">Process</a></li>
            ...
            <div id="approveindex" class="modal fade">
                <form class="form-horizontal" role="form" method="post" action="">
                    ...
                    <div class="modal-dialog box-default" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h3 class="modal-title"> Clearance Confirmation </h3>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
