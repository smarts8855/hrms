          ...
          <div class="modal-content">
            ...
            <div class="modal-body">  
                <div class="form-group" style="margin: 0 10px;">
                    <div class="col-sm-12">
                    <label class="control-label"><b>Enter Reason for restoration</b></label>
                    </div>
                    <div class="col-sm-12">
      ...
      <div class="row">
        ...
        {{ csrf_field() }}
            ...
            <div class="col-md-4">          
                   ...
                   <select required  name="awaitingby" class="form-control" onchange="ReloadForm()">
					  <option value="All">All</option>
					  @foreach($ApprovalReferal2 as $list)
					  <option value="{{$list->code}}" {{ ($awaitingby) == $list->code? "selected":"" }}>{{$list->description}}</option>
					  @endforeach
                ...
                <div class="col-md-4">          
                   ...
                   <select required  name="ptype" class="form-control" onchange="ReloadForm()">
					  ...
					  <option value="{{$list->id}}" {{ ($ptype) == $list->id? "selected":"" }}>{{$list->text}}</option>
					  @endforeach
                    </select>
                </div>
            </div>
                       ...
                       <tr @if($list->isrejected==1) style="background-color: red; color:#FFF;" @endif>
                            ...
                            <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                      ...
                                      <li><a   style="cursor: pointer;" onclick="return Archive('{{$list->ID}}')">Restore</a></li>
