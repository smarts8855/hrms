    ...
    <div class="box box-default">
        ...
        <div class="box-body">
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation">
                    <a href="#welfare" aria-controls="welfare" role="tab" data-toggle="tab">

                        Use Welfare Template
                    </a>
                </li>
            ...
            <div class="tab-content" style="margin-top:20px;">
                ...
                <div role="tabpanel" class="tab-pane fade" id="welfare">
                    ...
                    <form method="post" id="thisform1" name="thisform1">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <label class="control-label">&nbsp;</label>
                                    <button type="submit" class="btn btn-success form-control" name="addWithVoucherParameters">
                                        <i class="fa fa-btn fa-floppy-o"></i> Add Beneficiary
                                    </button>
                                </div>
                                <div class="col-md-3">
                                    <label class="control-label">&nbsp;</label>
                                    <a href="{{route('voucher.parameters.view')}}" type="button" class="btn btn-info form-control" name="add">
                                        <i class="fa fa-btn"></i> View Template Parameters
                                    </a>
                                </div>
                            </div>
                            <input id ="delcode" type="hidden" name="delcode">
                    ...
                    <table class="table table-bordered table-striped table-highlight">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="/cpo-submit-added-beneficiaries" method="POST">
                                    @csrf
                                    <input type="hidden" value="{{$claimid}}" name="cid">
                                    <button type="submit" class="btn btn-success text-uppercase">Submit
                                    </button>
                                </form>
                                @endif
                            </td>
