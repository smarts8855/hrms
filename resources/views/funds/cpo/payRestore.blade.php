                    ...
                    <div class="panel-body">
                        ...
                        <div>
                            <form action="{{ url('/cpo/restore') }}" method="post">
                                ...
                                <table id="myTable" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($audited as $list)
                                            @php
                                                $wtax = DB::table('tblepayment')
                                                    ->where('batch', $list->batch)
                                                    ->sum('WHTValue');
                                                $vtax = DB::table('tblepayment')
                                                    ->where('batch', $list->batch)
                                                    ->sum('VATValue');
                                                $amount = DB::table('tblepayment')
                                                    ->where('batch', $list->batch)
                                                    ->sum('amount');
                                            @endphp
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url('/view/batch/' . $list->batch) }}" target="_blank"
                                ...
                                <button type="submit" name="submit" value="Restore" class="btn btn-success pull-right">
                                    Restore
                                </button>
