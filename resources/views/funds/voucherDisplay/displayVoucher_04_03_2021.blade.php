	 ...
	 <div class="col-xs-12">
		<div class="box-body">
				...
				<div align="center" style="font-weight: 100">
					Departmental No. <b>FHC/OC/{{$list->vref_no}}/{{date('Y') - 1}}</b>. Checked and passed for payment at <b>Abuja</b>
				</div>
		</div>
	  </div>
	</div>
					...
					<div class="row">
						<div  align="left" class="col-xs-5">
							<div style="font-size: 16px; border:2px solid #ddd !important; padding: 0 2px;">
							    <h6>Payable at: <strong>FHC</strong></h6>
	...
	<div class="row">
	 <div class="col-xs-12">
		<div class="box-body">
				...
				<div align="center" style="font-weight: 100">
					Departmental No. <b>FHC/{{$list->economicCode}}/{{$list->vref_no}}/{{date('Y') - 1}}</b>. Checked and passed for payment at <b>Abuja</b>
				</div>
		</div>
	  </div>
	</div>
	 		...
	 		<table class="table table-bordered text-center table-condensed" style="font-size: 10px">
	 			<tbody>
	 				...
	 				<tr style="font-weight: bold;">
	 					...
	 					<td>0</td>
	 					<td>0</td>
	 					<td colspan="8">{{'FHC/'.$list->economicCode}}</td>
	 				</tr>
	 			</tbody>
	 		</table>
	 	</div>
	...
	<table class="table table-condensed table-bordered text-center input-sm">
		...
		<tbody>
			<tr>
				...
				<td rowspan="2" width="650">
					<div align="left">
						Being {{$list->premiumpercentage}}% of {{number_format($list->totalPayment,2)}} Premium Charge on P.V. NO. FHC/{{$list->economicCode}}/ {{$list->vref_no}} /{{date('Y')}} from
						<b>
	...
	<table class="table table-condensed table-bordered text-center input-sm">
		...
		<tbody>
			...
			<tr>
				...
				<td rowspan="2" width="650">
					<div align="left">
						Being {{$list->WHT}}% of {{number_format($totalPayment,2)}} W/H TAX deduction on P.V. NO. FHC/{{$list->economicCode}}/ {{$list->vref_no}} /{{date('Y')}} from
						<b>
							@if($list->contractor != ''){{$list->contractor}} @endif
							@if($list->contractor == ''){{$list->payee}} @endif
						</b>
	...
	<table class="table table-condensed table-bordered text-center input-sm">
		...
		<tbody>
			<tr>
				...
				<td rowspan="2" width="650">
					<div align="left">
						Being {{$list->VAT}}% of {{number_format($totalPayment,2)}} VAT payable on P.V. NO. FHC/{{$list->economicCode}} /{{$list->vref_no}} /{{date('Y')}} by
						<b>
							@if($list->contractor != ''){{$list->contractor}} @endif
	...
	<table class="table table-condensed table-bordered text-center input-sm">
		...
		<tbody>
			<tr>
				...
				<td rowspan="2" width="650">
					<div align="left">
						Being {{$list->stampdutypercentage}}% of {{number_format($totalPayment,2)}} Stamp Duty deduction on P.V. NO. FHC/{{$list->economicCode}}/ {{$list->vref_no}} /{{date('Y')}} from
						<b>
							@if($list->contractor != ''){{$list->contractor}} @endif
							@if($list->contractor == ''){{$list->payee}} @endif
						</b>
