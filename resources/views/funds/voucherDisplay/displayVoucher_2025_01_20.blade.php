...
@section('content')
    ...
    <div style="background: #FFFFFF; padding: 10px 30px;">
        <form method="post" action="{{ url('/CR/voucher/contract/create') }}">
            ...
            <div align="center" id="rem" style="background: #FFF;">
                ...
                <div style="float: right;width:100%; text-align:right"><b>ECONOMIC CODE: {{ $list->Code }}
                        {{ $list->economicCode }} </b></div>
                <br />
                        ...
                        <table class="table table-striped table-condensed table-bordered ">
                            ...
                            <tbody>
                                <tr class="input-lg">
                                    ...
                                    <th>
                                        <span>
                                            <div align="center">{{ number_format($list->totalPayment, 2, '.', ',') }}
                                            </div>
                                        </span>
                                    </th>
                                    <th></th>
                                ...
                                @if ($list->premiumcharge > 0)
                                    <tr class="input-lg">
                                        ...
                                        <th> <span style="font-weight: 100;">{{ $list->premiumpercentage }}% Premium Charge
                                            </span></th>
                                        <th></th>
                                        <th>
                                            <div align="center">{{ number_format($list->premiumcharge, 2, '.', ',') }}
                                            </div>
                                        </th>
                                    </tr>
                                @endif
                                ...
                                @if ($list->stampduty > 0)
                                    <tr class="input-lg ">
                                        <th class="text-center"><span>&#10004;</span></th>
                                        <th style="font-weight: 100;">
                                            {{ $list->stampdutypercentage }}% Stamp Duty
                                        </th>
                                        <th></th>
                                        <th>
                                            <div align="center">{{ number_format($list->stampduty, 2, '.', ',') }}</div>
                                        </th>
                                    </tr>
                                @endif
                                ...
                                <tr class="input-lg">
                                    ...
                                    <th></th>
                                    <th>
                                        <div align="center">{{ number_format($list->amtPayable, 2, '.', ',') }}</div>
                                    </th>
                                </tr>
    ...
    <div class="box-body" id="main" style="background: #fff;">
                ...
                <div class="col-xs-12">
                    <div class="box-body">
                        ...
                        <div align="center" style="font-weight: 100">
                            Departmental No. <b>SCN/@if ($list->contractTypeID == 6)
                                    PE
                                @else
                                    OC
                                @endif/<input type="text" class="noborder"
     ...
     <td></td> <td colspan="2"></td> <td></td> <td colspan="2"></td> <td colspan="2"></td> <td></td>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td colspan="2"></td>
                                <td colspan="14"><b>&#8358;{{ number_format($list->totalPayment, 2, '.', ',') }}</b>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="4">
                                    ...
                                    <table class="input-sm ">
                                        @if ($list->companyID != 13)
                                            @if ($contractAmount != $list->totalPayment)
                                                <tr>
                                                    <td width="200" style="border: none !important;">
                                                        <div align="left">
                                            ...
                                            @if ($list->premiumcharge > 0)
                                                <tr>
                                                    <td width="200" style="border: none !important;">
                                                        <div align="left">Total Amount(Premium Charge Inclusive)</div>
                                                    </td>
                                                    <td style="border: none !important;">
                                                        <div align="right">
                                            ...
                                            @if ($list->premiumcharge > 0)
                                                <tr>
                                                    <td style="border: none !important;" width="200">
                                                        <div align="left">Less {{ $list->premiumpercentage }}% Premium
                                                            Charge</div>
                                                    </td>
                                                    <td style="border: none !important;">
                                                        <div align="right" style="border-bottom: 2px solid #000;">
                                                            &#8358;{{ number_format($list->premiumcharge, 2, '.', ',') }}
                                                        </div>
                                                    </td>
                                                </tr>
                                            @endif
                                            ...
                                            @if ($list->premiumcharge > 0)
                                                <tr>
                                                    <td width="200" style="border: none !important;">
                                                        <div align="left">Amount(VAT Inclusive)</div>
                                                    </td>
                                                    <td style="border: none !important;">
                                                        <div align="right">
                                            ...
                                            @if ($list->VAT > 0)
                                                <tr>
                                                    <td style="border: none !important;" width="200">
                                                        <div align="left">Less {{ $list->VAT }}% VAT Payable</div>
                                                    </td>
                                                    <td style="border: none !important;">
                                                        <div align="right" style="border-bottom: 2px solid #000;">
                                                            &#8358; @if ($list->VATValue == 0)
                                            ...
                                            @if ($list->premiumcharge > 0)
                                                <tr>
                                                    <td style="border: none !important;" width="200">
                                                        <div align="left">Gross Amount</div>
                                                    </td>
                                                    <td style="border: none !important;">
                                                        <div align="right">
                                            ...
                                            @if ($list->WHT > 0)
                                                <tr>
                                                    <td style="border: none !important;" width="200">
                                                        <div align="left">Less {{ $list->WHT }}% W/H Tax</div>
                                                    </td>
                                                    <td style="border: none !important;">
                                                        <div align="right">&#8358; @if ($list->WHTValue == 0)
                                                                {{ $list->WHTValue }}
                                            ...
                                            @if ($list->stampduty > 0)
                                                <tr>
                                                    <td style="border: none !important;" width="200">
                                                        <div align="left">Less {{ $list->stampdutypercentage }}% Stamp
                                                            Duty</div>
                                                    </td>
                                                    <td style="border: none !important;">
                                                        <div align="right">&#8358; @if ($list->stampduty == 0)
                                                                {{ $list->stampduty }}
                            ...
                            <div class="row">
                                <div align="left" class="col-xs-5">
                                    <div style="font-size: 16px; border:2px solid #ddd !important; padding: 0 2px;">
                                        ...
                                        <h6>Initiated By: <strong>
                                                @if ($approvedBy != '')
                                                    {{ $approvedBy->name }}
                                                @endif
                                            </strong></h6>
                                        <h6>Prepared By: <strong>
                                                @if ($preparedBy != '')
                                                    {{ $preparedBy->name }}
                                                @endif
                                            </strong></h6>
                                        <h6>Passed By: <strong></strong></h6>
                                        <h6>Liability Taken By: <strong>
                                                @if ($libilityBy != '')
                                                    {{ $libilityBy->name }}
                                                @endif
                                            </strong></h6>
                                        <h6>Checked By: <strong>
                                                @if ($checkBy != '')
                                                    {{ $checkBy->name }}
                                                @endif
                                            </strong></h6>
                                        <h6>Audited By: <strong>
                                                @if ($auditedBy != '')
                                                    {{ $auditedBy->name }}
                                                @endif
                                            </strong> </h6>
    ...
    @if ($list->premiumcharge > 0)
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box-body">
                            <div align="center">
                                <h4>
                                    <div>
                                        ...
                                        @if ($list->contractTypeID == 4 || $list->contractTypeID == 10)
                                            <div>
                                                <h4 class="text-center">
                                                    {{ strtoupper('CAPITAL EXPENDITURE PAYMENT VOUCHER') }}</h4>
                                            </div>
                                            <div>
                                                <h4 class="text-center">{{ strtoupper('CAPITAL BUDGET ONLY') }}</h4>
                                            </div>
                                        ...
                                        <div class="clearfix"></div>
                                        @if ($list->contractTypeID == 4)
                                            <span class="pull-right"><small>Treasury F27</small></span>
                                        @else
                            ...
                            <div align="center" style="font-weight: 100">
                                Departmental No. <b>SCN/{{ $list->economicCode }}/<span
                    ...
                    @if ($list->contractTypeID != 4)
                        <div class="col-xs-3">
                            ...
                            <table style="font-size: 10px; margin-top: -25px;">
                                ...
                                <tr>
                                    <td>
                                        <div class="vertical-text v-align-4">has been entered on TF 174 (A) (B) or (C)
                                        </div>
                                    </td>
                                </tr>
                                <tr>
     ...
     <td></td> <td colspan="2"></td> <td></td> <td colspan="2"></td> <td colspan="2"></td> <td></td>
                                ...
                                <tr style="font-weight: bold;">
                                    ...
                                    <td>0</td>
                                    <td>0</td>
                                    <td colspan="8">{{ 'SCN/' . $list->economicCode }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <table class="table table-condensed table-bordered text-center input-sm">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td rowspan="2" width="650">
                                <div align="left">
                                    Being {{ $list->premiumpercentage }}% of {{ number_format($list->totalPayment, 2) }}
                                    Premium Charge on P.V. NO. SCN/{{ $list->economicCode }}/ <span
                                        class="vrefNo">{{ $list->vref_no }}</span> /{{ date('Y') }} from
                                    <b>
                                        @if ($list->contractor != '')
                                            {{ $list->contractor }}
                                        @endif
                                    ...
                                    @elseif(stripos($newDscription, 'Being Balance payment to the above named'))
                                        !== false)
           ...
           <td style="border: none !important;" width="200"><div align="left">Total Amount(Premium Charge Inclusive) </div></td>
            <td style="border: none !important;"><div align="right" style="border-bottom:2px solid #000;"> &#8358;{{ number_format($list->totalPayment, 2, '.', ',') }}</div>
                                        ...
                                        <tr>
                                            <td style="border: none !important;" width="200">
                                                <div align="left">Less {{ $list->premiumpercentage }}% Premium Charge
                                                </div>
                                            </td>
                                            <td style="border: none !important;">
                                                <div align="right" style="border-bottom:2px solid #000;">
                                                    &#8358;{{ number_format($list->premiumcharge, 2, '.', ',') }}</div>
                                            </td>
                                        </tr>
                                    ...
                                    <!--<div>I certify that the expenditure was incured in the interest of Public Service.</div>
          <div align="center"><b> (Chief Registrar)</b></div>-->
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-8" style="font-size: 11px;">
                                        ...
                                        <div align="left">
                                            ...
                                            that the amount of <b><span id="resultTAX"></span></b> may be paid under the
                                            Classification quote.
                                        </div>
                                        <div style="text-decoration: underline;">
                                            <b>&nbsp;&nbsp; For Chief Registrar &nbsp;&nbsp;</b>
                ...
                <div style="margin-top: -20px; font-size: 8px;">
                    Received from the Federal Government of Nigeria the sum of <span id="resultTAX2"
                        style="font-size: 8px;"></span> in full settlement of the Account.
                ...
                <table class="table table-condensed table-bordered text-center input-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td rowspan="2" width="650">
                                <div align="left">
                                    Being {{ $list->WHT }}% of {{ number_format($totalPayment, 2) }} W/H TAX deduction
                                    on P.V. NO. SCN/{{ $list->economicCode }}/ <span
                                        class="vrefNo">{{ $list->vref_no }}</span> /{{ date('Y') }} from
                                    <b>
                                        @if ($list->contractor != '')
                                            {{ $list->contractor }}
                                    ...
                                    <table class="input-sm">
                                        ...
                                        <tr>
                                            <td style="border: none !important;" width="200">
                                                <div align="left">Less {{ $list->WHT }}% WHT Payable</div>
                                            </td>
                                            <td style="border: none !important;">
                                                <div align="right" style="border-bottom:2px solid #000;">
                                                    &#8358;{{ number_format($list->WHTValue, 2, '.', ',') }}</div>
                                            </td>
                                        </tr>
    ...
    <div class="col-xs-8" style="font-size: 11px;">
        ...
        <div align="left">
            ...
            dully performed; that the rate/price charge is according to regulations/contract is fair and reasonable: <br />
    ...
    <div style="margin-top: -20px; font-size: 8px;">
        Received from the Federal Government of Nigeria the sum of <span id="resultTAX2" style="font-size: 8px;"></span>
                ...
                <table class="table table-condensed table-bordered text-center input-sm">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td rowspan="2" width="650">
                                <div align="left">
                                    Being {{ $list->VAT }}% of {{ number_format($totalPayment, 2) }} VAT payable on
                                    P.V. NO. SCN/{{ $list->economicCode }} /<span
                                        class="vrefNo">{{ $list->vref_no }}</span> /{{ date('Y') }} by
                                    <b>
                                        @if ($list->contractor != '')
                                            {{ $list->contractor }}
                                        @endif
                                    ...
                                    <table class="input-sm">
                                        ...
                                        <tr>
                                            <td style="border: none !important;" width="200">
                                                <div align="left">{{ $list->VAT }}% VAT Payable</div>
                                            </td>
                                            <td style="border: none !important;">
                                                <div align="right" style="border-bottom:2px solid #000;">
                                                    &#8358;{{ number_format($list->VATValue, 2, '.', ',') }}</div>
                                            </td>
                                        </tr>
                                    ...
                                    <!--<div>I certify that the expenditure was incured in the interest of Public Service.</div>
          <div align="center"><b>Mr. Gambo Saleh (Chief Registrar)</b></div>-->
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-8" style="font-size: 11px;">
                                        ...
                                        <div align="left">
                                            ...
                                            quoted, that the service have been dully performed; that the rate/price charge
                                            is according to regulations/contract is fair and reasonable: <br />
                                            that the amount of <b><span id="resultVAT"></span></b> may be paid under the
                                            Classification quote.
                                        </div>
                                        <div style="text-decoration: underline;">
                                            <b>&nbsp;&nbsp; For Chief Registrar &nbsp;&nbsp;</b>
                ...
                <div style="margin-top: -20px; font-size: 8px;">
                    Received from the Federal Government of Nigeria the sum of <span id="resultVAT2"
                        style="font-size: 8px;"></span> in full settlement of the Account.
                    <small> Date.................{{ $list->period }}
                        &nbsp;&nbsp;&nbsp;
                        Signature..........
                ...
                <table class="table table-condensed table-bordered text-center input-sm">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td rowspan="2" width="650">
                                <div align="left">
                                    Being {{ $list->stampdutypercentage }}% of {{ number_format($totalPayment, 2) }}
                                    Stamp Duty deduction on P.V. NO. SCN/{{ $list->economicCode }}/ <span
                                        class="vrefNo">{{ $list->vref_no }}</span> /{{ date('Y') }} from
                                    <b>
                                        @if ($list->contractor != '')
                                            {{ $list->contractor }}
                                    ...
                                    <table class="input-sm">
                                        ...
                                        <tr>
                                            <td style="border: none !important;" width="200">
                                                <div align="left">Less {{ $list->stampdutypercentage }}% Payable</div>
                                            </td>
                                            <td style="border: none !important;">
                                                <div align="right" style="border-bottom:2px solid #000;">
                                                    &#8358;{{ number_format($list->stampduty, 2, '.', ',') }}</div>
                                            </td>
                                        </tr>
                    ...
                    <tbody>
                        ...
                        @foreach ($staff as $s)
                            <tr>
                                ...
                                @endif
                                <td class="" align="right"><?php $totalAmt += $s->amount; ?>{{ number_format($s->amount, 2) }}
                                </td>
