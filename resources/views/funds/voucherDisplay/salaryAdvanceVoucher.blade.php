	 ...
	 <div class="col-xs-12">
		<div class="box-body">
				...
				<div align="center" style="font-weight: 100">
					Departmental No. <b>SCN/PE/<input type="text" class="noborder" style="border:none; width:40px !important;" transid="{{$list->transID}}" id="vref" value="{{$list->vref_no}}" />/{{date('Y', strtotime($list->datePrepared))}}</b>. Checked and passed for payment at <b>Abuja</b>
				</div>
		</div>
	  </div>
	</div>
