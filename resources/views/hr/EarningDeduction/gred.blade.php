...
<div class="box box-default">
      ...
      <div class="row">
        ...
        {{ csrf_field() }}
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-12 hidden-print"><h4>MONTHLY EARNING & DEDUCTION</h4></div>
                    <div class="col-md-6 ">
                    <table class="table table-bordered table-striped table-highlight hidden-print">
                     	@if ($CourtInfo->courtstatus==1)
                        <tr>
                            <td>Court:</td>
            ...
            <div class="col-md-12" style="padding:10px; font-size:16px;">
               <!-- -->


       <div class="col-md-12">

  <table class="hd" border="0" align="left" cellpadding="0" cellspacing="0" style="margin-bottom:30px; margin-top:20px;">
  <tr>
  <th>NIGERIA FEDERAL GOVERNMENT</th>
  </tr>
  <tr><th>ADVICE OF DEDUCTION FROM SALARY</th></tr>
  @if($typen !='')
  <tr><th>{{strtoupper($typen->description)}} FOR THE MONTH OF {{strtoupper($monthn)}}</th></tr>
  @endif
  ...
  <tr style="border-top:2px solid #000;">
          ...
          <td align="right"><div align="right"><strong></strong>&#8358;{{number_format($sum, 2, '.', ',')}}</div></td>
 ...
 <script type="text/javascript">
	var amount = "";
	var amount = "{{number_format($sum, 2, '.', ',')}}";
