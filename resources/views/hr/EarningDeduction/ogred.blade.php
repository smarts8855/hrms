...
@section('pageTitle')
Occasional Earning Deduction Report Details
@endsection
      ...
      <div class="row">
        ...
        {{ csrf_field() }}
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-12"><h4>OCCASIONAL EARNING & DEDUCTION REPORT DETAILS</h4></div>
                    <div class="col-md-6 ">
            ...
            <div class="table-responsive col-md-12" style="font-size: 12px; padding:10px;">
                <table id="ttr" class="table table-bordered table-striped table-highlight" >
                    <thead>
...
<script>
   ...
   function myFunc(){
    ...
    {
        var exportme = $('#ttr').html;
        //console.log(exportme);

        var page = "excelpage.php?nmm=Monthly-Earning-Deduction-Report-Details&filex="+exportme;
