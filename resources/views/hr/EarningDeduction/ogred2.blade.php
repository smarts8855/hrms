...
@section('pageTitle')
Occasional Earning Deduction Report Summary
@endsection
      ...
      <div class="row">
            ...
            @endif
                ...
                <div class="col-md-4">
                    ...
                    <select required id="type" name="type"  onchange="getTable()" class="form-control" >
                        ...
                        <option value="1" {{ (  $type == "1" ) ? "selected" : "" }}>Earning</option>
                        <option value="2" {{ ( $type == "2" ) ? "selected" : "" }}>Deduction</option> 
                    </select>
                </div>
            </div>
            </div>
        ...
        {{ csrf_field() }}
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-12"><h4>OCCASIONAL EARNING & DEDUCTION REPORT SUMMARY</h4></div>
                    <div class="col-md-6 ">
            ...
            <div class="table-responsive col-md-12" style="font-size: 12px; padding:10px;">
                <table class="table table-bordered table-striped table-highlight" >
                    <thead>
                        ...
                        <tr bgcolor="#c7c7c7">
                            <th><b> EARNING DEDUCTION DETAILS </b></th>
                            <th><b> AMOUNT </b></th>
                        </tr>
                    </thead>
                    @php $sum = 0; @endphp
