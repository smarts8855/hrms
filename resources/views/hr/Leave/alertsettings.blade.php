...
<div class="box box-default"> 
	...
	<form method="post" action="{{ route('savePeriod') }}"  class="form-horizontal">
		{{ csrf_field() }}
		<div class="box-body">
	    ...
	    <div>
			<div class="form-group" style="margin-left:2px"> 
	            ...
	            <div class="col-lg-10">
                    ...
                    <input class="form-control" name="NumberOfDays" id="NumberOfDays" type="text" placeholder="Enter number of days" required> 
	            </div>

                <div class="col-lg-2" style="margin-top:22px">
                <button type="submit" class="btn btn-success" name="Save">
					<i class="fa fa-btn fa-floppy-o"></i> Save / Update
			</button>
	            </div>
...
<tr bgcolor="#c7c7c7">
			...
			@foreach ($period as $b)
				...
				<td>{{ $serialNum ++}} </td>
                    ...
                    <!-- <td> 
                        <a onclick="funcUpdate('{{$b->alertID}}')"><span class="btn btn-primary"> Edit</span></a>
                    </td> -->
