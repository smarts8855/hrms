        ...
        <div class="modal-dialog box box-default" role="document">
          <div class="modal-content">
            ...
            <form class="form-horizontal"
                    role="form" method="POST" action="/approve/leave">
                    {{ csrf_field() }}
            <div class="modal-body">
...
<div id="rejectModal" class="modal fade">
        <div class="modal-dialog box box-default" role="document">
          <div class="modal-content">
            ...
            <form class="form-horizontal"
                    role="form" method="POST" action="/finalreject/leave">
                    {{ csrf_field() }}
            <div class="modal-body">
                <div class="form-group" style="margin: 0 10px;">
 ...
 <div id="cancelModal" class="modal fade">
        <div class="modal-dialog box box-default" role="document">
          <div class="modal-content">
            ...
            <form class="form-horizontal"
                    role="form" method="POST" action="/finalcancel/leave">
                    {{ csrf_field() }}
            <div class="modal-body">
                <div class="form-group" style="margin: 0 10px;">
 ...
 function myFunction() {
  ...
  <script>
   ...
   function viewfunc2(x)
   {
        ...
        var appid = x;
        //alert(memberID);
        $.get('/comments/view-a?appID='+appid, function(data){
         var html = '';
              //html +='<tr bgcolor="#c7c7c7" align="center" style="font-size:22px;">';
		      //html +='<th align="center">Staff</th>';
		      //html +='<th align="center">Comment</th>';
