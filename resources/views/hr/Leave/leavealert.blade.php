                    ...
                    {{-- @if ($days >= 0 && $days <= $period) --}}
                        <tr>
                            ...
                            <td>
                                ...
                                @elseif($b->startDate < $today && $today <= $b->endDate)
                                    <span class="badge badge-success">Should be on leave</span>
                                @elseif($today > $b->endDate)
                                    <span class="badge badge-success">Should be back on sit</span>
                                @endif
