		...
		<div class="box-body">
			 ...
			 <div class="form-group">
				...
				<input class="form-control" id="disabledInput" type="text" placeholder="{{$AppliedLeave[0]->LeavesType}}" disabled="">
			 	...
			 	<div class="col-lg-4">
	            		<label>Purpose</label>
				<textarea class="form-control"  rows="2" disabled="">{{$AppliedLeave[0]->purpose}}</textarea>
	            		</div>
	            		<div class="col-lg-4">
	            		<label>Address during the leave</label>
				<textarea class="form-control"  rows="2" disabled="">{{$AppliedLeave[0]->addressDuringLeave}}</textarea>
	            		</div>
	            		<div class="col-lg-4">
	            		<label>Releave staff commnent</label>
				...
				@endif
	            	...
	            	<div class="form-group">
	            		...
	            		@if ($AppliedLeave[0]->status=='Pending')
				<textarea class="form-control" name="remarks" rows="2" ></textarea>
				@else
				<textarea class="form-control" rows="2" disabled="">{{$AppliedLeave[0]->approvalComment}}</textarea>
				@endif
	            		</div>
				...
				<button type="submit" class="btn btn-success" name="accept">
						<i class="fa fa-btn fa-floppy-o"></i> Approved
				</button>
