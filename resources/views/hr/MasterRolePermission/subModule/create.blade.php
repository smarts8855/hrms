  ...
  <div id="page-wrapper" class="box box-default">
            ...
            {{ csrf_field() }}
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9">
                          <input id="name" type="text" class="form-control" name="route" value="{{ old('name') }}" required>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9">
                          <input id="name" type="number" class="form-control" name="rank" value="{{ old('name') }}" required>
                        </div>
                      </div>
          ...
          <tbody>
            ...
            @foreach($submodules as $list)
              <tr>
                  ...
                  <td>{{$list->sub_module_rank}}</td> 
                  <td><a href="javascript:;" title="Edit" onClick='getData("{{$list->modulename}}", "{{$list->submodulename}}", "{{$list->submoduleID}}", "{{$list->sub_module_rank}}", "{{$list->route}}")' class="btn btn-success fa fa-edit edit"></a></td>  <!--id="{{$list->submoduleID}}"-->        
              </tr>
            @endforeach
          </tbody>
        </table>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="form-group">
            <label for="section" class="col-md-3 control-label">Select Module</label>
            <div class="col-md-9">
              <select id="modulename" name="modules" class="form-control">
          ...
          <div class="form-group">
            <label for="section" class="col-md-3 control-label">Sub Module Name</label>
            <div class="col-md-9">
                <input id="subModule" type="text" class="form-control text-capitalize" name="subModules" value="" required>
              <input id="subModuleID" type="hidden" class="form-control text-capitalize" name="subModuleID" value="" required>
          ...
          <div class="form-group">
            <label for="section" class="col-md-3 control-label">Route</label>
            <div class="col-md-9">
              <input id="routes" type="text" class="form-control text-capitalize" name="routes" value="" required>
            </div>
          </div>
        </div>
      ...
      <div class="row"> 
       <div class="form-group">
         <label for="section" class="col-md-3 control-label">Rank</label>
          <div class="col-md-9">
            <input id="rank" type="number" class="form-control" name="ranks" value="" required>
            
          </div>
        </div>
      </div>  
        <script>
            function getData(data1, data2, data3, data4, data5){
                console.log(data5)
                const modulename     = document.getElementById(data1);
                const submodule     = document.getElementById('subModule');
                const submoduleID   = document.getElementById('subModuleID');
                const routes        = document.getElementById('routes');
                const rank          = document.getElementById('rank');
                
                $(document).ready(function(){
                    //alert('working')
                $("select#modulename option")
                .each(function() { this.selected = (this.text == data1); });
                })
                submodule.value     = data2;
                routes.value        = data5;
                submoduleID.value   = data3;
                rank.value   = data4;
                //alert(modulename.innerHTML);
            }
        </script>
