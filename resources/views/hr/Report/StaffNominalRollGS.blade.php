	...
	<form method="post"  id="thisform1" name="thisform1">
		...
		<div class="box-body">
			...
			@endif
				...
				<select name="designation" id="designation" class="form-control" data-designation="{{$designation}}"  >
			 ...
			 <div class="row">
	            		...
	            		<div class="col-md-2">
	            		 <div class="form-group">
                              ...
                              <input type="text" name="fromdate" id="fromdate" class="form-control" value="{{date_format(date_create($fromdate),'d F Y')}}"/>
	            		...
	            		<div class="col-md-2">
	            		 <div class="form-group">
                              ...
                              <input type="text" name="todate" id="todate" class="form-control" value="{{date_format(date_create($todate),'d F Y')}}"/>
			...
			<tr bgcolor="#c7c7c7">
						...
						@foreach ($QueryStaffReport as $b)
							...
							<td>{{$b->StaffName}}</td>
								...
								<td class="dob"> @if ($b->employee_type==3) Con @else{{$b->grade}} @endif</td>
								<td class="dob">@if ($b->employee_type==3)- @else{{$b->step}} @endif</td>
