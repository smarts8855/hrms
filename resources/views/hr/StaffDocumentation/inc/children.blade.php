<form action="{{url('/staff-documentation-children')}}" method="POST">
	{{csrf_field()}}
		<div class="tab-pane" role="tabpanel" id="step3">
			...
			<div class="row col-md-offset-1">
				...
				<div class="col-md-2">
						...
						<input type="text" name="childDateOfBirth[]" id="childDateOfBirthb" value="{{ date('d-m-Y', strtotime($children[0]->dateofbirth)) }}" class="form-control input-lg" readonly>
						
						@else
						<label>Date of Birth</label>
						<input type="text" name="childDateOfBirth[]" id="childDateOfBirth2b" value="{{old('childDateOfBirth[]')}}" class="form-control input-lg" readonly>
						@endif
			...
			<div class="row col-md-offset-1">
				...
				<div class="col-md-2">
						...
						<label>Date of Birth</label>
						<input type="text" name="childDateOfBirth[]" id="childDateOfBirtha" value="{{date('d-m-Y', strtotime($children[1]->dateofbirth)) }}" class="form-control input-lg" readonly>
						
						@else
						<label>Date of Birth</label>
						<input type="text" name="childDateOfBirth[]" id="childDateOfBirth2a" value="{{old('childDateOfBirth[]')}}" class="form-control input-lg" readonly>
						@endif
				...
				<div class="col-md-2">
						...
						<label>Date of Birth</label>
						<input type="text" name="childDateOfBirth[]" id="childDateOfBirthy" value="{{ date('d-m-Y', strtotime($children[2]->dateofbirth)) }}" class="form-control input-lg" readonly>
						
						@else
						<label>Date of Birth</label>
						<input type="text" name="childDateOfBirth[]" id="childDateOfBirth2y" value="{{old('childDateOfBirth[]')}}" class="form-control input-lg" readonly>
						@endif
			...
			<div class="row col-md-offset-1">
				...
				<div class="col-md-2">
						...
						<label>Date of Birth</label>
						<input type="text" name="childDateOfBirth[]" id="childDateOfBirthx" value="{{ date('d-m-Y', strtotime($children[3]->dateofbirth)) }}" class="form-control input-lg" readonly>
						
						@else
						<label>Date of Birth</label>
						<input type="text" name="childDateOfBirth[]" id="childDateOfBirth2x" value="{{old('childDateOfBirth[]')}}" class="form-control input-lg" readonly>
						@endif
			...
			<div align="center">
				<ul class="list-inline">
					<li><a href="{{url('/staff-documentation-nextofkin')}}" class="btn btn-default">Previous</a></li>
