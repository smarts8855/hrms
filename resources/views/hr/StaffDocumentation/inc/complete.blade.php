<form action="{{url('/staff-documentation-complete')}}" method="POST">
  {{csrf_field()}}
...
<div class="row">
    <div class="checkmark">
      ...
      <p id="words">Registration Complete! for {{$StaffNames}}</p>
    </div>                  
</div>
...
<div align="center">
		<ul class="list-inline">
			...
			<li>
				<button type="submit" class="btn btn-primary">Go back </button><!--next-step-->
			</li>
		</ul>
	</div>