<form action="{{url('/staff-documentation-previous-employment')}}" method="POST">
			{{csrf_field()}}
				<div class="tab-pane" role="tabpanel" id="step3">
					...
					<div class="row">
						...
						<div class="col-md-2">
							...
							@else
							<label>Checked By</label>
							  <input type="text" name="checkedBy[]" id="checkedBy" class="form-control input-lg" value=""/> 
							@endif
				...
				<div class="row">
					...
					<div align="center">
						<ul class="list-inline">
							<li><a href="{{url('/staff-documentation-children')}}" class="btn btn-default">Previous</a></li>
