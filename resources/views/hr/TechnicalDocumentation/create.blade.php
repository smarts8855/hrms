      ...
      <div class="row">
        ...
        {{ csrf_field() }}
            ...
            <div class="col-md-6">          
                    ...
                    <input required id="category" name="category" type="text" value="{{ $category }}"  class="form-control">
                </div>
                        ...
                        @foreach($tablecontent as $list)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button onclick="return editfunc('{{ $list->id }}')" class="bt btn-xs btn-info">Create Module</i></button>
                                </td>
                            </tr>
                        @endforeach                    
                    </tbody>                    
...
<script>
   ...
   function populate()
   {
    ...
    function editfunc(x)
    {
        ...
        window.location.assign("/add/module/"+x);
        return false;
    }
