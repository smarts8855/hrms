      ...
      <div class="row">
        ...
        {{ csrf_field() }}
            ...
            <div class="col-md-6">          
                    ...
                    <input required id="category" name="category" type="text" readonly="readonly" " value="{{ $category }}"  class="form-control">
                </div>
                
                <div class="col-md-6">
                    <label class="control-label">Module</label>
                    <input required id="module" name="module" type="text" readonly="readonly" " value="{{ $module }}"  class="form-control">
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-2">
                    ...
                    <input required id="modby" name="modby" type="text" readonly="readonly" " value="{{$modby}}"  class="form-control">
                </div>
                ...
                <div class="col-md-6">
                    <label class="control-label"> Description of Modification</label>
