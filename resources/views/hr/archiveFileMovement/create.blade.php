        ...
        <div class="box-body box-profile">
            <div class="box-header with-border hidden-print">
                <h3 class="box-title"><b>@yield('pageTitle')</b> <i class="fa fa-arrow-right"></i> <span id='processing'>
                        <strong><em>Retrieve file from archive.</em></strong> </span></h3>
            </div>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="box box-default">
                                            <div class="box-header with-border hidden-print">
                                                <h3 class="box-title">Search By File Number <span id='processing'></span>
                                                </h3>
                                            </div>
                        ...
                        <form method="post" action="{{ url('/archive-movement/retrieve') }}">
                            {{ csrf_field() }}
                            ...
                            {{-- <div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<option value="{{$section->id}}" @if (old('destination') == $section->id) selected @endif >{{$section->department}}</option>
										@endforeach
                            ...
                            {{-- <div class="row" id="outhidden">
								...
								<div class="col-md-6" id="inhidden">
									<div class="form-group">
										...
										<input type="text" name="transferDate" id="transferdate" class="form-control" value="{{date('m-d-Y')}}"/>
									</div>
								</div>
								<div class="col-md-6" id="inhidden">
									<div class="form-group">
										<label for="month">Expected Return Date <span class="text-danger"><b>*</b></span></label>
										<input type="text" name="returnDate" id="returndate" class="form-control" value="{{old('returnDate')}}"/>
									</div>
								</div>
							</div>
                                    ...
                                    <div class="col-md-9">
                                        {{-- <div align="right" class="form-group">
                                            ...
                                            <button name="action" class="btn btn-success" type="submit">
                                                Retrieve <i class="fa fa-save"></i>
                                            </button>
                                        </div> --}}

                                        <button type="button" class="btn btn-sm btn-success"
                                            data-toggle="modal" data-backdrop="false"
                                            data-target="#confirmRetrieve"> Retrieve
                                        </button>

                                        <!-- Modal to confirm -->

                                        <div class="modal fade text-left d-print-none"
                                            id="confirmRetrieve" tabindex="-1" role="dialog"
                                            aria-labelledby="confirmRetrieve" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="text-success text-center">
                                                            <h4>Are you sure you want to retrieve file from archives
                                                                </h4>
                                                        </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit"
                                                            class="btn btn-success archiveFile">Yes Retrieve</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            $.ajax({
                ...
                success: function(datas) {
                    ...
                    $.each(datas, function(index, obj) {
                        ...
                        tr.append("<td>"+ obj.othernames +"</td>");
                        tr.append("<td>"+ obj.Designation +"</td>");*/
                        tr.append("<td> " + obj.volume_name +
                            " <input type='hidden' class='form-control length' style='width:80px;' name='volume[]' value='" +
                            obj.old_volumeID + "'></td>");
						tr.append("<td> " + obj.shelve_number +
                            " <input type='hidden' class='form-control length' style='width:80px;' value='"+
                            obj.shelve_number +"'></td>");
                        // tr.append("<td><input type='text' class='form-control length' style='width:80px;' name='lastPage[]'></td>");
