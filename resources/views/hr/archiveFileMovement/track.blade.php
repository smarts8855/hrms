...
<div class="row" style="padding: 1px 12px; margin-bottom: 20px;">
  <div class="col-md-12" style=" padding: 10px 15px">
        <div class="col-md-6"><!-- outer cover -->
        <h5 class="text-center">Search by Date</h5>
           <div class="col-md-6" style="padding: 1px;">

              <div class="form-group">
                <label>Start Date</label>
                <input type="text" name="from" id="fromDate" placeholder="Select Date" class="form-control" value="{{ old('from') }}">
              </div>
            </div>
            <div class="col-md-6" style="font-size: 13px;">
              <div class="form-group">
                <label>End Date</label>
                 <input type="text" name="to" id="toDate" placeholder="Select Date" class="form-control" value="{{ old('to') }}">

              </div>
            </div>
            </div><!-- ///outer cover -->
            <div class="col-md-3" style="padding-left: 0px;"><!-- outer cover -->
            <h5 class="text-center">Search by Section</h5>
            <div class="col-md-12" style="font-size: 13px; padding: 0px;">
              <div class="form-group">
                <label>Section</label>
                  <select name="section" id="dept" class="form-control" style="font-size: 13px;">
            ...
            <div class="col-md-2" style="padding: 0px;"><!-- outer cover -->
            <h5 class="text-center">Search By File Number</h5>
            <div class="col-md-12" style="padding: 1px;font-size: 13px;font-weight: 100;">
              <div class="form-group">
                <label>File Number</label>
                <input type="text" name="staffNo" id="staffNo" class="form-control" value="{{ old('staffNo') }}" style="font-size: 13px;"/>
            ...
            <div class="col-md-1" style="padding: 1px;">
              <div class="form-group" style="padding-top: 26px; margin-top: 33px;">
    ...
    <table class="table table-bordered table-striped" id="servicedetail" width="100%">
							...
							@php
							  ...
							  $dest = DB::table('tbldepartment')->where('id','=',$list->destination)->first();
							...
							<td>
							    <a href="javascript:void" id="{{$list->fileNo ?? ''}}" bulkID="{{$list->bulkID ?? ''}}" reason="{{$db->comment ?? ''}}" class="reason" > View Comment</a>
							</td>
