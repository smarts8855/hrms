...
@section('pageTitle')
  Add Council Members BAT Number
  
@endsection

@section('content')
  <form method="post" action="{{ url('/council-bat/create') }}">
{{ csrf_field() }}
        ...
        <div class="row">
            <div class="col-md-12"><!--1st col-->
				...
				<div class="col-md-12" style="background:#fff;"><!--2nd col-->
                         ...
                         <h4 class="" style="text-transform:uppercase"> Add Council Members BAT Number</h4>
...
<div>
  <table class="table table-responsive table-bordered" style="margin-top:60px;">
             ...
             <td>{{$list->month}}</td>
             <td>{{$list->batNo}}</td>
             <td><a href="{{url("/council-bat/edit/$list->Id")}}" class="btn btn-success">Edit</a></td>
             </tr>
            @endforeach
              </tbody>
        </table>
