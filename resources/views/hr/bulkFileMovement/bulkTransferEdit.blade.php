    ...
    <div class="box box-default">
        <div class="box-body box-profile">
            <div class="box-header with-border hidden-print">
                <h3 class="box-title"><b>@yield('pageTitle')</b> <i class="fa fa-arrow-right"></i> <span id='processing'> <strong><em>Send File to New Recipient...</em></strong> </span></h3>
            </div>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <form method="post" action="{{ url('/bulk-transfer/updatefile') }}">
                            {{ csrf_field() }}
                                    ...
                                    <table class="table table-bordered table-striped" id="servicedetail" width="100%">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control length" style="width:80px;"
                                                        name="volume" value="{{ $file->fileVolume }}"></td>
                                                <td><input type="text" class="form-control length" style="width:80px;"
                                                        name="lastPage" value="{{ $file->fileLastPage }}"></td>
                                            </tr>
                            ...
                            <div class="row">
                                ...
                                {{-- <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="month">Name Of Recipient <span
                                                class="text-danger"><b>*</b></span></label>
                                        <select name="recipient" id="recipient" class="form-control">
                                            <option value="{{ $recipient->UserID }}">{{ $recipient->surname }}
                                                {{ $recipient->first_name }} {{ $recipient->othernames }}</option>
                                        </select>
                                    </div>
                                </div> --}}
                            ...
                            <div class="row" id="outhidden">
                                ...
                                <div class="col-md-6" id="inhidden">
                                    <div class="form-group">
                                        <label for="month">Date of Transfer <span
                                                class="text-danger"><b>*</b></span></label>
                                        <input type="text" name="transferDate" id="transferdate" class="form-control"
                                            value="{{ date('d-m-Y', strtotime(trim($file->date_transfered))) }}" />
                                    </div>
                                </div>
                                <div class="col-md-6" id="inhidden">
                                    <div class="form-group">
                                        <label for="month">Expected Return Date <span
                                                class="text-danger"><b>*</b></span></label>
                                        <input type="text" name="returnDate" id="returndate" class="form-control"
                                            value="{{ date('d-m-Y', strtotime(trim($file->return_date))) }}" />
                                    </div>
                                </div>
                            </div>
