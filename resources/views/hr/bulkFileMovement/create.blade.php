 ...
 <div class="box box-default">
    <div class="box-body box-profile">
    	<div class="box-header with-border hidden-print">
        	<h3 class="box-title"><b>@yield('pageTitle')</b> <i class="fa fa-arrow-right"></i> <span id='processing'> <strong><em>Transfer files... </em></strong></h3>
    	</div>
						...
						<div class="col-md-12">
						 <div class="row">
						  <div class="col-md-12">
						    <div class="box box-default">
						      <div class="box-header with-border hidden-print">
						        <h3 class="box-title">Search By File Number <span id='processing'></span></h3>
						      </div>
						      <form method="post" action="{{ url('staff/store') }}">
						        <div class="box-body">
						          <div class="form-group">
						            {{ csrf_field() }}
						           <input id="autocomplete" name="q" class="form-control dos" placeholder="Search File">
							...
							<div class="row" id="outhidden">
								...
								<div class="col-md-6" id="inhidden">
									<div class="form-group">
										...
										<input type="text" name="transferDate" id="transferdate" class="form-control" value="{{date('d-M-Y')}}"/>
									</div>
								</div>
								<div class="col-md-6" id="inhidden">
									<div class="form-group">
 ...
 headers: {'X-CSRF-TOKEN': $token},
   ...
   success: function(datas){
    ...
    $.each(datas, function(index, obj){
        ...
        tr.append("<td>"+ obj.othernames +"</td>");
        tr.append("<td>"+ obj.Designation +"</td>");*/
        tr.append("<td> "+ obj.volume_name +" <input type='hidden' class='form-control length' style='width:80px;' name='volume[]' value='"+ obj.volume +"'></td>");
        tr.append("<td><input type='text' class='form-control length' style='width:80px;' name='lastPage[]'></td>");
