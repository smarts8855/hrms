        ...
        <div class="box-body box-profile">
            <div class="box-header with-border hidden-print">
                <h3 class="box-title"><b>@yield('pageTitle')</b> <i class="fa fa-arrow-right"></i> <span
                        id='processing'><strong><em>Create File.</em></strong></span></h3>
            </div>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                                            ...
                                            @if (isset($getCategory) && $getCategory)
                                                @foreach ($getCategory as $listCat)
                                                    <option value="{{ $listCat->Id }}"
                                                        {{ $listCat->Id == old('fileCategory') ? 'selected' : '' }}>
                                                        {{ $listCat->category }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                        ...
                                        <select name="volume" id="volume" class="form-control">
                                            ...
                                            @if (isset($getVolume) && $getVolume)
                                                @foreach ($getVolume as $listVol)
                                                    <option value="{{ $listVol->ID }}"
                                                        {{ $listVol->ID == old('volume') ? 'selected' : '' }}>
                                                        {{ $listVol->volume_name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                            ...
                            <div class="row" id="outhidden">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="shelfNo" id="shelfNo" class="form-control"
                                        value="{{ old('shelfNo') }}" placeholder="1,2...." />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                        ...
                        <a name="" id="" class="btn btn-primary" href="{{route('files.created')}}" role="button">See Files..</a>
                    </div>
                </div><!-- /.col -->
            </div><!-- /.row -->
