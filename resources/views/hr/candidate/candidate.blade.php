...
@section('pageTitle')
    <strong>Add Candidate For Interview: {{ strtoUpper($interviewDetails->title) }}</strong>
@endsection
                ...
                <div class="box-body">
                    ...
                    <div class="form-group" style="margin-left:10px; margin-right:10px">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <label>Address</label>
                                <textarea class="form-control" id="editorx" name="address" rows="1" required></textarea>
                            </div>
