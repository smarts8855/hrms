...
@section('content')
    <div class="box box-default">
            ...
            <div class="box-body">
                ...
                <div class="form-group" style="margin-left:10px; margin-right:10px">
                    <div class="form-group row">
                        <div class="col-lg-4">
                            ...
                            <select class="form-control" name="title" id="title" required>
                                <option value="{{ $candidate->candidate_title }}" {{ isset($candidate) ? 'selected' : '' }} > {{ $candidate->candidate_title }} </option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <select name="maritalStatus" id="maritalStatus" required class="form-control">
                                <option value="{{ $candidate->maritalStatus }}" {{ isset($candidate) ? 'selected' : '' }}>{{ $candidate->maritalStatus }}</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <label>Address</label>
                            <textarea class="form-control" id="editorx" name="address" rows="3" required>{{ $candidate->address }}</textarea>
        ...
        <a href="{{ route('Candidate.add', ['id' => $candidate->interview_titleID]) }}" class="btn btn-warning" >Go
            Back</a>
    </div>
    </div>
@endsection
