...
<div class="col-md-12">
<table class="table" width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size:18px" >
  <tr>
...
@if($courtname != ''){{ $courtname->court_name }} @elseif($courtDivisions != '') {{$courtDivisions->court_name}}, {{$courtDivisions->division}} @endif</h3></td>
  ...
  <tr>
    <td width="1294">
    <strong>MONTH ENDING: </strong><br/>       </td>
...
<br>
  <div>
    <h2>  <a  class= "no-print" type="submit" class="btn btn-success btn-sm pull-right" href = "{{ url()->previous()  }}">Back</a></h2>
  </div>
<div align="center">
  @if(count( $payroll_detail ) > 0)
 <input type="submit"  value="Check & clear" class="btn btn-success btn1" id="btn" />
 <input type="submit"  value="Reject" class="btn btn-success btn1" id="btn" />
  @endif
</div>
<!-- Modal HTML -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        @endforeach
        <form method="post" action="{{url('/checking/clear')}}">
          {{ csrf_field() }}
          ...
          <div class="row">
            ...
            <!--<div class="col-md-12">
              <div class="form-group">
                <label for="month">Refer To</label>
