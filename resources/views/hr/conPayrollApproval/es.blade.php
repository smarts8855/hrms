...
<div align="center">
 ...
 <input type="submit"  value="Process" class="btn btn-success" id="btn" />
    ...
    @endif
    @if(!is_null($track))
  @if(count($payroll_detail) == 0 && $track->sent_by == auth::user()->username)
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        @endforeach
        <form method="post" action="{{url('/con-payroll/es')}}" style="margin-top:10px;">
          {{ csrf_field() }}
          <input type="hidden"  value="{{$year}}" name="year" class="btn btn-success" />
          <input type="hidden"  value="{{$month}}" name="month" class="btn btn-success" />
          ...
          <input type="submit" class="btn btn-success proceed" name="submit" value="Approve" />
