  ...
  @endsection
  @section('content')
  <form method="POST" action="{{ url('/council-members/update') }}">
    <div class="box-body" style ="background:#fff;">
      <div class="row">
        ...
        {{ csrf_field() }}
        <div class="col-md-12">
         <h4 class="" style="text-transform:uppercase">Edit Council Members</h4>
          <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              <label >Title</label>
              <input type="text" name="title" class="form-control" value="{{$cm->council_title}}"> 
           ...
           <div class="col-md-3">
            <div class="form-group">
              <label >Surname</label>
              <input type="text" name="surname" class="form-control" value="{{$cm->surname}}"> 
              <input type="hidden" id="id" name="id" value="{{$cm->ID}}">
            </div>
          </div>
          <div class="col-md-3">
            <div class="form-group">
              <label >First Name</label>
              <input type="text" name="firstName" class="form-control"  value="{{$cm->first_name}}"> 
            </div>
          </div>
          <div class="col-md-3">
            <div class="form-group">
              <label >Other Names</label>
              <input type="text" name="otherNames" class="form-control" value="{{$cm->othernames}}"> 
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="form-group">
              <label >P.V.No.</label>
              <input type="text" name="pvNumber" class="form-control" value="{{$cm->fileNo}}"> 
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <select name="bank" id="section" class="form-control">
                ...
                <option value="{{$list->bankID}}" @if($cm->bankID == $list->bankID) selected @endif>{{$list->bank}}</option>
                @endforeach
              </select>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="text" name="accountNumber" class="form-control" value="{{$cm->AccNo}}"> 
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select name="status" id="status" class="form-control">
                ...
                <option value="1" @if($cm->staff_status==1) selected @endif >Active </option>
                <option value="0" @if($cm->staff_status==0) selected @endif>Inactive </option>
              </select>
            </div>
          </div>
