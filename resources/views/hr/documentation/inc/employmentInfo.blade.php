							<form action="{{url('/registration/employment-info')}}" method="POST">
        							{{csrf_field()}}
					                        		...
					                        		<div class="col-md-6">
					                        			 <div class="form-group">
											              <label>Date of Appointment <span class="text-danger"><big>*</big></span></label>
											              	@if($fillUpForm != '')
													        	<input type="text" readonly name="presentAppointment2" id="presentAppointment2" class="form-control input-lg" value="{{$fillUpForm->date_present_appointment}}" required />
					                        		...
					                        		<div class="col-md-6">
					                        			<div class="form-group">
											              <label>Date of first Appointment <span class="text-danger"><big>*</big></span></label>
											               @if($fillUpForm != '')
													        	<input type="text" readonly name="firstAppointment2" id="firstAppointment2" class="form-control input-lg" value="{{$fillUpForm->appointment_date}}" required />
					                        ...
					                        <hr />
					                         <div align="center">
						                        <ul class="list-inline">
						                            <li>
						                            	<a href="{{ url('/documentation-contact')}}" class="btn btn-default">Previous</a>
						                            </li>
						                            <li>
