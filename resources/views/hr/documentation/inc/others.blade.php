    ...
    <div class="tab-pane" role="tabpanel" id="step3">
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="col-md-12" style="padding-top: 10px;">
                    <label>6. Are you a judgement Debtor? or are there any write from debts outstanding against
                        you?</label>
                    @if ($otherInfo == '')
                ...
                <div class="col-md-12" style="padding-top: 10px;">
                    ...
                    @if ($otherInfo != null)
                        <select name="religion" id="changeReligion" name="religion" class="form-control input-lg"
                            value="" required>
                            <option value="" selected>Select</option>
                            @foreach ($religions as $faith)
                                <option value="{{ $faith->Religion }}"
                                    {{ $otherInfo->qtn10 == $faith->Religion ? 'selected' : '' }}>{{ $faith->Religion }}
                                </option>
                            @endforeach
                        </select>
                    @else
                ...
                <div class="col-md-12" style="padding-top: 10px;">
                    ...
                    @endif
                    <label for="agree"> I hereby certify on honour that the information given over the above area
        ...
        <div align="center">
            <ul class="list-inline">
                <li><a href="{{ url('/documentation-passport-signature') }}" class="btn btn-default">Previous</a></li>
