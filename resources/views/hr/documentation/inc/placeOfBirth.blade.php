			...
			<div class="tab-pane" role="tabpanel" id="step3">
				...
				<p>
					...
					<div class="col-md-8 col-md-offset-2">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<label>Contact Address <span class="text-danger"><big>*</big></span></label></label>
									@if($staffInfo !== '')
								<textarea name="address" id="address" class="form-control input-lg" required>{{$staffInfo->permanent_addr}}</textarea>
									@else
				...
				<div align="center">
					<ul class="list-inline">
						<li><a href="{{url('/documentation-contact')}}" class="btn btn-default">Previous</a></li>
