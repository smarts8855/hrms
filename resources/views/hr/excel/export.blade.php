    ...
    <div class="box-body box-profile" style="margin:0 5px;">
		...
		<p>
			<h4 class="text-success text-center">
				<strong>Export Login Details</strong>
			</h4>
		</p>
		...
		<div class="row">
			<div class="col-sm-12">
				...
				<div style="margin: 0px  5%;">
					...
					<form id="form1" name="form1" method="post" action="{{url('/login/details/export')}}" enctype="multipart/form-data">
					{{ csrf_field() }}
					...
					<input type="submit" name="submit" id="button" value="Export" class="btn btn-success" style="margin-top: 10px" />
					</form>
					 </div>
					    <!--//for update-->
