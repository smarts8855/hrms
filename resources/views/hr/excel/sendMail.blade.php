    ...
    <div class="box-body box-profile" style="margin:0 5px;">
		...
		<p>
			<h3 class="text-success text-center">
				<strong>{{strtoupper('Email Login Details')}}</strong>
			</h3>
		</p>
		...
		<div class="row">
			<div class="col-sm-12">
				...
				<div style="margin: 0px  5%;">
					...
					<form id="form1" name="form1" method="post" action="{{url('/profile/sendmail')}}" enctype="multipart/form-data">
					{{ csrf_field() }}
					<div class="col-md-12">
					<label class="control-label" for="fullName">SELECT COURT</label>
					...
					<input type="submit" name="submit" id="button" value="Send" class="btn btn-success" />
					</div>
					</form>
					 </div>
					    <!--//for update-->
