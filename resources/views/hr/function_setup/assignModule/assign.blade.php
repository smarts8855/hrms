...
<form method="post" action="{{ url('/assign-module/assign') }}" class="form-horizontal">
  ...
  <div class="row">
        ...
        echo '<div class="col-md-9 col-md-offset-2" style="padding-left:0px; margin-top:8px;"><strong>Module: '.$list->modulename.'</strong></div>';

        $current_module = $list->moduleID;
        }
        ?>
  <div class="form-group" style="margin:10px">
    <div style="clear: both;"></div>
    <div class="col-md-9 col-md-offset-2" style="margin-top: 8px">
      <input type="hidden" name="modu[]" value="{{$list->moduleID}}"/>
      ...
      <span style="padding: 10px; font-weight: bold;">{{strtoupper($list->submodulename)}}</span> </div>
  </div>
  @endforeach
  <div class="form-group">
