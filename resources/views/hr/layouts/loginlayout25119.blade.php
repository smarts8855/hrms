...
<head>
  ...
  <title>JIPPIS | Judicial Integrated Personnel And Payroll Management System </title>
      ...
      <header class="main-header">
          <nav class="navbar navbar-static-top" style="background: #0B610B">
           <div align="center" style="color: #fff; font-size: 26px; padding: 10px;">
              <b> {{ strToUpper('Judicial Integrated Personnel And Payroll Management System')}}</b>
                ...
                <nav class="navbar navbar-static-top" style="background: #0B610B">
                  <div align="center" style="color: #fff; font-size: 15px; padding: 10px;">
                     <!--<img src="{{asset('Images/coat.jpg')}}" height="30" style="border-radius: 4px;">-->
                      <b>Designed by</b> <a href="http://mbrcomputers.net" target="_blank" style="color: white;">MBR Computer Consultants</a> |
