...
@endsection
@section('content')
<form method="post" action="{{ url('nhf/report') }}">
  <div class="box-body" style="background:#FFF;">

    <div class="box-header with-border hidden-print">
        <h3 class="box-title"><b>@yield('pageTitle')</b> <i class="fa fa-arrow-right"></i>  <span id='processing'><strong><em>NHF Report.</em></strong></span></h3>
    </div>
