            ...
            <div class="table-responsive">
                <table class="table table-striped table-condensed table-bordered">
                    ...
                    <tbody>
                            ...
                            <tr>
                                <td>{{$monthlyDeduction->surname}} {{$monthlyDeduction->first_name}} {{$monthlyDeduction->othernames}}</td>
                                <td>{{$monthlyDeduction->fileNo}}</td>
                                <td>{{$monthlyDeduction->Dept}}</td>
                                <td>{{$monthlyDeduction->grade}}</td>
                                <td>{{$monthlyDeduction->NHF}}</td>
                                <td>
                                    <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-backdrop="false" data-target="#confirmToSubmit{{$monthlyDeduction->perID}}">Update Deduction.</button>
                                </td>

                            </tr>

                            <form action="{{url('nhf-staff-monthly-deduction-update/'.$monthlyDeduction->perID)}}" method="POST">
                            @csrf @method('PUT')
                            <!-- Modal to delete -->
                            <div class="modal fade text-left d-print-none" id="confirmToSubmit{{$monthlyDeduction->perID}}" tabindex="-1" role="dialog" aria-labelledby="confirmToSubmit" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="text-success text-center"> <h4>You want to update deduction For {{$monthlyDeduction->surname}} {{$monthlyDeduction->first_name}} </h4></div>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-8 col-md-offset-2">
                                                        ...
                                                        <input type="text" class="form-control" name="deduction" value="{{$monthlyDeduction->NHF}}">
                                                    </div>
