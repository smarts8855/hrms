  ...
  <div class="box box-default" style="border: none;">
      ...
      <div class="box-header with-border hidden-print">
          <h3 class="box-title"><b>@yield('pageTitle')</b> <i class="fa fa-arrow-right"></i> <span
                  id='processing'><strong><em>Deduction.</em></strong></span></h3>
      </div>

      <form method="POST" action="{{ url('/nhis/deduction') }}">
          <div class="box-body">
              <div class="row">
                  <div class="col-md-12">
                      <!--1st col-->
                  ...
                  <div class="col-md-12">
                      <div class="row">
                          ...
                          <div class="col-md-12">
                              <div class="form-group">
                                  <div>
                                      <button type="submit" class="btn btn-success btn-sm pull-right">Display
                                          Workings</button>
                                  </div>
                              </div>
                          </div>
