...
@section('pageTitle')
	Letter Of Appointment REPORT
@endsection

@section('content')
<div class="box box-default" style="border-top: none;">
	<form action="{{url('/offerofappointment/viewletters')}}" method="post">
	{{ csrf_field() }}
    ...
    <div style="margin: 10px 20px;">
    	<big><b>{{strtoupper('Letter of Appointment ')}}</b></big>
	...
	<div class="box-body">
		<div class="row">
            ...
            <th></th>
                    ...
                    <td>
                      <form method="post" action="{{url('/offerofappointment/print-letter-from-list')}}">
                      {{ csrf_field() }}
