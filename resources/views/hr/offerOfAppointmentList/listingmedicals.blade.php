...
<div class="box box-default" style="border-top: none;">
	<form action="{{url('/offerofappointment/viewmedical')}}" method="post">
	{{ csrf_field() }}
        <div class="box-header with-border hidden-print">
          ...
          <span class="pull-right" style="margin-right: 30px;">
          	 <div style="float: left;">
          	 	<div class="wrap">
				   <div class="search"> &nbsp;
				   <a href="{{url('/offerofappointment/viewmedical')}}" title="Refresh"><i class="fa fa-refresh"></i> Refresh</a>
				   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div style="margin: 10px 20px;">
    	<big><b>{{strtoupper('MEDICAL EXAMINATION FOR CONFIRMATION OF APPOINTMENT ')}}</b></big>
	...
	<div class="box-body">
		<div class="row">
            ...
            <th></th>
                    ...
                    <td>
                      <form method="post" action="{{url('/offerofappointment/print-medical-from-list')}}">
                      {{ csrf_field() }}
