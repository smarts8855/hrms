...
<div class="box box-default" style="border-top: none;">
  <form action="{{url('/open-file-registry/filterclosed')}}" method="post">
    ...
    <div class="box-header with-border hidden-print">
      ...
      <div style="float: left;">
        <div class="wrap">
          <div class="search"> &nbsp; <a href="{{url('/open-file-registry/view-closed-files')}}" title="Refresh"><i class="fa fa-refresh"></i> Refresh</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <div style="margin: 10px 20px;"> <big><b>{{strtoupper('Viewing Closed Files ')}}</b></big> <span class="pull-right" style="margin-right: 30px;">Printed On: {{date('D M, Y')}}.</span> @if(session('err'))
