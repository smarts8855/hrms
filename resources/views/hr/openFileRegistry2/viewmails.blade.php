...
<div class="box box-default" style="border-top: none;">
  <form action="{{url('/open-file-registry/filter')}}" method="post">
    {{ csrf_field() }}
    <div class="box-header with-border hidden-print">
      ...
      <div style="float: left;">
        <div class="wrap">
          <div class="search"> &nbsp; <a href="{{url('/open-file-registry/view-mails')}}" title="Refresh"><i class="fa fa-refresh"></i> Refresh</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <div style="margin: 10px 20px;"> <big><b>{{strtoupper('Viewing Mails ')}}</b></big> <span class="pull-right" style="margin-right: 30px;">Printed On: {{date('D M, Y')}}.</span> @if(session('err'))
      ...
      <div class="col-md-12">
        <table class="table table-striped table-condensed table-bordered">
          ...
          <tr>
            ...
            <td>{{ date('d F, Y', strtotime($list->date_dispatched)) }}</td>
...
<script type="text/javascript">
  $(function() {
      ...
      $("#autocomplete").autocomplete({
        serviceUrl: murl + '/open-file-registry/search',
        minLength: 2,
