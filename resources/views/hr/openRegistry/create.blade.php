                            ...
                            <form method="post" action="">
                            	...
                            	<select name="fileid" id="fileid" class="form-control">
									...
									<option value="{{$prolist->fileNo}}">
										{{$prolist->surname . ' '. $prolist->first_name .' - '. $prolist->fileNo }}
									</option>
									@endforeach          
								 </select>			
							</form>
...
<script type="text/javascript">
	$( function() {
    	$( "#returndate" ).datepicker({changeMonth: true,changeYear: true,dateFormat: 'yy-mm-dd'});
    	$( "#dateopen" ).datepicker({changeMonth: true,changeYear: true,dateFormat: 'yy-mm-dd'});
  	});
