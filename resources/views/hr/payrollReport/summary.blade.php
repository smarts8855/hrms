...
<table class="table-condense table-responsive" border="1" cellpadding="4" cellspacing="0">
  <tr>
   <td width="44" rowspan="2" align="center" valign="middle"><strong>FILE NO</strong></td>
    ...
    <td colspan="11" align="center" valign="top"><strong>EARNINGS</strong></td>
  ...
  <tr>
    ...
    <td width="41" align="center" valign="middle"><strong>JUSU</strong></td>
...
<td width="52" align="center" valign="middle"><strong>TOTAL EARNING</strong></td>
    ...
    <td width="80" align="center" valign="middle"><strong>TOTAL DEDUCTION</strong></td>
