...
<option value="">Select</option>
            ...
            @if($div->divisionID == session('divsession'))
               <option value="{{$div->divisionID}}" selected>{{$div->division}}</option>
               @else
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" id="user" autocomplete="off" list="enrolledUsers"  class="form-control"  onchange="StaffSearchReload()">
	   ...
	   @endforeach
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label for="userName">Staffnane</label>
