	...
	<div class="box-body">
      <div class="row">
        <div class="col-md-12">
          <div>
          <div>
            <h4>ALL PENSION REPORTS FOR - 
              <b>{{$staff->surname .' '. $staff->first_name .' '. $staff->othernames}}</b>
            </h4>
          </div>
          @foreach($getAllPension as $r)
          <table class="table table-striped table-condensed table-bordered">
             <tr>
                  <td rowspan= "5" valign="center "><strong>{{$r->year}}</strong></td>
             </tr>
              <tr>
