...
@endsection
@section('content')
<h2>Council Members Bank Schedule</h2>
<form method="post" action="{{ url('/council-member/bank-schedule') }}">
        ...
        <div class="col-md-6">
         ...
         <!--
          <div class="col-md-6">
            <div class="form-group">
              <label>warrant</label>
              <select name="warrant"  class="form-control">
                <option value="G/W" selected="selected">General Warrant</option>
                <option value="P/W">Provisional Warrant</option>
              </select>
            </div>
          </div>-->
          <div class="col-md-6">
