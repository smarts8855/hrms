  ...
  @endsection
  @section('content')
  <form method="POST" action="{{ url('/council-members/mandate-approval') }}" target="_blank">
 ...
 <div class="col-md-6">
          ...
          <div class="col-md-12">
            <div class="form-group">
              <div >
                <button type="submit" class="btn btn-success btn-sm pull-right">View Mandate</button>
              </div>
            </div>           
          </div>
