        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12"> <br>
                    ...
                    <form method="post" id="mandateForm" action="{{ url('user/assign-mandate') }}" class="form-horizontal"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="firstSignatory" name="firstSignatory">
                                ...
                                @foreach ($mandateprofile as $list)
                                    <option value="{{ $list->id }}"
                                        {{ old('firstSignatory', $selected_first) == $list->id ? 'selected' : '' }}>
                                        {{ $list->Name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="secondSignatory" name="secondSignatory">
                                ...
                                @foreach ($mandateprofile as $list)
                                    <option value="{{ $list->id }}"
                                        {{ old('secondSignatory', $selected_second) == $list->id ? 'selected' : '' }}>
                                        {{ $list->Name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <tbody>
                            ...
                            @foreach ($viewsignatories as $pv)
                                <tr>
                                    ...
                                    <td><a href="{{ url('user/delete-signatory') }}/{{ $pv->id }}"
