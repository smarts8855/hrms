...
<div class="box box-default" style="border-top: none;">
  ...
  <div class="box-body">
<div></div>
 <form method="post" action="{{url('/report/search-staff')}}" class="hidden-print">
          {{ csrf_field() }}
              ...
              <div class="form-group">
                <label>Division</label>
                 <select name="division" id="division" class="form-control input-lg" style="font-size: 13px;">
                  ...
                  @if(session('search_division') == $d->divisionID)
    ...
    <div class="row">
      ...
      <div class="col-md-12">
       ...
       <div class="pagination"> {{ $staff->links() }}</div>
        <div align="left">
        <form method="post" action="{{url('/report/export/excel')}}" class="hidden-print">
        {{ csrf_field() }}
