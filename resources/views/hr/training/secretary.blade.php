...
@section('content')
    <div class="box box-default" style="padding-bottom:30px">
        <div class="box-header with-border hidden-print">
            <h3 class="box-title"><b>@yield('pageTitle')</b> <i class="fa fa-arrow-right"></i> <span id='processing'> <strong><em>Secretary Approve training.</em></strong> </span></h3>
        </div>
        <div class="box-body">
            <div class="row">
                ...
                <div class="table-responsive">
                    <table style="padding-left:30px; margin-bottom:150px" id="datatable-buttons"
                            ...
                            @if (isset($trainings))
                                @foreach ($trainings as $key => $training)
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-success btnComment" id="viewComment"
                                                data-id="{{ $training->ID }}" data-toggle="modal"
                                                data-target="#commentModal">View Comment</button>
                                        </td>

                                        <td class="row align-items-center">
                                            @if ($training->tStatus == 3)
                                                {{-- if status 3 (secretary status then approve link) and change status to completed --}}
                                                ...
                                                <a href="#" data-toggle="modal"
                                                    class="btn btn-info text-warning push_module" data-toggle="modal"
                                                    data-target="#push" data-id="{{ $training->ID }}">Forward Training
                                                </a>

                                                <a href="#" data-toggle="modal" class="btn btn-warning revert_module"
