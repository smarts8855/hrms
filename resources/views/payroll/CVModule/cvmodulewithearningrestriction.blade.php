...
<div class="box box-default">
  <div class="box-body box-profile">
    ...
    <div class="col-md-12">
                ...
                @endif
               <!--  <div class="alert alert-success alert-dismissible" id="alert-s" role="alert">
		              	<button type="button" class="close" data-dismiss="alert" aria-label="Close">
		              		<span aria-hidden="true">&times;</span>
		                </button>
		                <strong>Error!</strong> 
	            ...
	            <div class="alert alert-danger alert-dismissible" id="alert-e" role="alert">
		              	<button type="button" class="close" data-dismiss="alert" aria-label="Close">
		              		<span aria-hidden="true">&times;</span>
		                </button>
		                <strong>Error!</strong> 
                    ...
                    @foreach($tablecontent as $list)
                        <tr>
                            ...
                            <td>
                                ...
                                onclick="editfunc('{{$list->ID }}','{{$list->description}}', '{{$list->courtID}}', '{{$list->divisionID}}', '{{$list->amount}}')">Edit</button>
