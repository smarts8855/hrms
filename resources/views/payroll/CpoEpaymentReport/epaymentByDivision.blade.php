...
@endsection
@section('content')
    <form method="POST" action="{{ url('/cpo-epayment-by-division/retrieve') }}" target="_blank">
        <div class="box-body" style="background:#fff;">
            <div class="row">
                ...
                {{ csrf_field() }}
                <div class="col-md-12">
                    <h4 class="" style="text-transform:uppercase">Epayment Report By Division</h4>
                    <div class="row">
                        ...
                        @if ($CourtInfo->divisionstatus == 1 && Auth::user()->is_global == 1)
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="divisionID" id="division" class="form-control" disabled style="font-size: 13px;">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <div>
                                    <button type="submit" class="btn btn-success btn-sm pull-right">Generate Epayment
                                        Details</button>
                                </div>
                            </div>
                        </div>
