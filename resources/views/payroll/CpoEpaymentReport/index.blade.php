...
@endsection
@section('content')
<form method="POST" action="{{ url('/cpo-epayment/retrieve') }}" target="_blank">
...
<div class="col-md-6">
        ...
        <div class="col-md-12">
          <div class="form-group">
            <div >
              <button type="submit" class="btn btn-success btn-sm pull-right">Generate Staff Epayment Schedule</button>
            </div>
          </div>           
        </div>
      </div>
