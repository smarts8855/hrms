...
@endsection
@section('content')
<form method="POST" action="{{ url('/cpo-epayment-justice/retrieve') }}" target="_blank">
  <div class="box-body" style ="background:#fff;">
    <div class="row">
      ...
      {{ csrf_field() }}
      <div class="col-md-12">
       <h4 class="" style="text-transform:uppercase">Epayment Report Justices</h4>
        <div class="row">
...
<div class="col-md-6">
        ...
        <div class="col-md-12">
          <div class="form-group">
            <div >
              <button type="submit" class="btn btn-success btn-sm pull-right">Generate Justice Epayment Schedule</button>
            </div>
          </div>           
        </div>
      </div>
