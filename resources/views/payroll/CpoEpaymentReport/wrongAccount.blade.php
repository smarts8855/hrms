...
@endsection
@section('content')
<form method="POST" action="{{ url('/update-wrong-account/retrieve') }}" target="_blank">
  <div class="box-body" style ="background:#fff;">
    <div class="row">
      ...
      {{ csrf_field() }}
      <div class="col-md-12">
       <h4 class="" style="text-transform:uppercase">Update Bank Details for Epayment Report</h4>
        <div class="row">
...
<div class="col-md-6">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <option value="">Select Bank</option>
               ...
               <option value="{{$list->bankID}}" @if(old('bankName') == $list->bankID) selected @endif>{{$list->bank}} </option>
               @endforeach
            </select>
          </div>
        </div>
        ...
        <div class="col-md-12">
          <div class="form-group">
            <div >
              <button type="submit" class="btn btn-success btn-sm pull-right">Generate Epayment Details</button>
            </div>
          </div>           
        </div>
      </div>
