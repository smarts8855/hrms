...
@section('content')
  <form method="post" action="{{ url('/overdue-arrears/compute') }}" id="form">
	{{ csrf_field() }}
  <div class="box-body">
          <div class="row">
            <div class="col-md-12">
            ...
            <div class="col-md-4">
             <!-- <div class="form-group">
               ...
               <div class="form-group">
                ...
                <input type="hidden" id="nameID"  name="staffList">
              </div>
            ...
            <div class="col-md-4">
              ...
              <div class="form-group dueDate">
                <label>Arrears Due Date</label>
                <input type="text" name="dueDate" id="dueDate" class="form-control" value="{{old('due')}}"  autocomplete="false" />
              </div>
              
              <div class="form-group">
                <label>Arrears End Date</label>
                <input type="text" name="endDate" id="endDate" class="form-control" value="{{old('endDate')}}"  autocomplete="false"/>
              </div>
...
$( function() {
  ...
  $(function() {
    $("#autocomplete").autocomplete({
      serviceUrl: murl + '/searchUser/active',
      minLength: 2,
