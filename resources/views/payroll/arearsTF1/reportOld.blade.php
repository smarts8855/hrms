...
<div align="center" style="padding:0 2%;" class="mview">
    ...
    <table class="table table-condensed" style="background: transparent;">
                ...
                <tr>
                    ...
                    <td style="border: none;"><div class="text-right"></div>
                </tr>
                <tr>
                    <td style="border: none;"><div class="text-left">Departmental No NICN/PE/..........................</div></td>
                    <td style="border: none;"><div class="text-right">{{$record -> division}} Division</div></td>
                </tr>
    </table>
      ...
      <div class="row">
        <div class="col-md-10 col-md-offset-1">
          <table class="table table-responsive table-bordered mtable">
            ...
            <tbody>
              <tr>
                <td align="center">{{$record -> month}} &nbsp;&nbsp; {{$record -> year}}</td>
                <td align="left">
                  Payment to the above named  
                 
                  <Strong>{{$record -> name}}</strong>
                  {{ $getStatus }}
                  as salary arears in respect of FJSC 2018 promotion exercise. Vide Specification overleave for details. <br />
                  NIC/P/I.............
                </td>
