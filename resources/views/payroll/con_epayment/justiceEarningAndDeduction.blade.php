  ...
  @endsection
  @section('content')
      <form method="POST" action="{{ url('/retrieve-justice-earning-deduction-by-bank') }}" target="_blank">
          <div class="box-body" style ="background:#fff;">
              <div class="row">
                  ...
                  {{ csrf_field() }}
                  <div class="col-md-12">
                      <h4 class="" style="text-transform:uppercase">Earning and Deduction Report (JUSTICE)</h4>
                      <div class="row">
                          ...
                          @if ($CourtInfo->divisionstatus == 1 && Auth::user()->is_global == 1)
                              <div class="col-md-6">
                                  <div class="form-group">
                                      ...
                                      <select name="divisionID" id="division" class="form-control"
                          ...
                          @else
                              ...
                              <input type="hidden" id="division" name="divisionID"
                          ...
                          <div class="col-md-6">
                              <div class="form-group">
                                  ...
                                  <select name="month" id="section" class="form-control">
                                      ...
                                      <option value="MARCH" @if (old('month') == 'MARCH') selected @endif>March
                                      </option>
                                      <option value="APRIL" @if (old('month') == 'APRIL') selected @endif>April
                                      </option>
                                      <option value="MAY" @if (old('month') == 'MAY') selected @endif>May</option>
                                      <option value="JUNE" @if (old('month') == 'JUNE') selected @endif>June
                                      </option>
                                      <option value="JULY" @if (old('month') == 'JULY') selected @endif>July
                                      </option>
                          ...
                          <div class="col-md-6">
                              <div class="form-group">
                                  ...
                                  <input type="hidden" name="bankGroup" id="bankGroup" class="form-control"
                                      value="{{ old('startDate') }}" />
                          ...
                          <div class="col-md-12">
                              <div class="form-group">
                                  <div>
                                      <button type="submit" class="btn btn-success btn-sm pull-right">Generate
                                          Schedule</button>
                                  </div>
                              </div>
                          </div>
