      ...
      <form method="POST" action="{{ url('/council-members/create') }}">
          <div class="box-body" style ="background:#fff;">
              <div class="row">
                  ...
                  {{ csrf_field() }}
                  <div class="col-md-12">
                      <h4 class="" style="text-transform:uppercase">Create Justices Members</h4>
                      <div class="row">
                                  ...
                                  <select name="bank" id="section" class="form-control">
                                      ...
                                      @foreach ($banks as $list)
                                          <option value="{{ $list->bankID }}"
                                              @if (old('bank') == $list->bankID) selected @endif>{{ $list->bank }}
                                          </option>
                                      @endforeach
                                  </select>
                              </div>
                          ...
                          <div class="col-md-4">
                              <div class="form-group">
                                  <label>Rank</label>
                                  <input type="number" name="judge_rank" class="form-control">
                              </div>
                          </div>
                                  ...
                                  <tbody>
                                      @foreach ($cm as $list)
                                          <tr>
                                              ...
                                              <td>{{ $list->AccNo }} <br> {{ $list->bank }}</td>
                                              <td>{{$list->judge_rank}}</td>
                                              <td><a href="{{ url('/edit/council-member/' . $list->ID) }}"
                                                      class="btn btn-success"><i class="fa fa-pencil"></i></a></td>
                                          </tr>
                                      @endforeach
