                ...
                <form method="post" style="margin-top:10px; padding-top:20px;" id="mainform" name="mainform"
                            ...
                            <div class="form-group">
                                ...
                                <datalist id="enrolledUsers" name="staff">
                                    @foreach ($staffData as $list)
                                        <option value="{{ $staff->ID }}">
                                            {{ $staff->fileNo }}:{{ $staff->surname }} {{ $staff->first_name }}
                                            {{ $staff->othernames }}
                                        </option>
                                    @endforeach
                                </datalist>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="Text" name="employeeType" id="employeeType" class="form-control" readonly
                                value="@if ($staff != '') {{ $staff->oldEmploymentType }} @endif" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="Text" name="newEmployeeType" id="employeeType" class="form-control" readonly
                                value="@if ($staff != '') {{ $staff->newEmploymentType }} @endif" />
                            ...
                            <input type="hidden" name="newEmpType" id="newEmpType" class="form-control" readonly
                                value="{{ isset($staff) ? trim($staff->newEmploymentType) : '' }}" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="Text" name="oldGrade" id="oldGrade" class="form-control" readonly
                                value="{{ isset($staff) ? trim($staff->old_grade) : '' }}" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="type">New Grade</label>
                            <select name='newGrade' class="form-control" readonly>
                                <option value=""></option>
                                @for ($i = 1; $i <= 17; $i++)
                                    <option value="{{ $i }}"
                                        @if ($staff->new_grade == $i) selected @endif>{{ $i }}</option>
                                @endfor
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="Text" name="oldStep" id="oldStep" class="form-control" readonly
                                value="{{ isset($staff) ? trim($staff->old_step) : '' }}" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name='newStep' class="form-control" readonly>
                                <option value=""></option>
                                @for ($i = 1; $i <= 17; $i++)
                                    <option value="{{ $i }}"
                                        @if ($staff->new_step == $i) selected @endif>{{ $i }}</option>
                                @endfor
                            </select>
                        </div>
                    </div>
