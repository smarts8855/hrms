                            ...
                            <div class="form-group">
                                ...
                                <select name="division" id="" class="form-control">
                                    ...
                                    @foreach ($courtDivisions as $div)
                                        ...
                                        {{-- <option value="{{$div->divisionID}} @if (old('division') == $divisions->divisionID) @endif" selected="selected"> --}}
                    ...
                    <tbody>
                        @foreach ($due as $d)
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($d->doc_url)
                                        <a class="btn btn-info" href="{{ asset($d->doc_url) }}"
                                            target="_blank">View</a>
                                    @endif
                                </td>
                                <th>
                                    <div align="right">
                                        <a onclick="return ConfirmDelete('{{ $d->ID }}')" title="Remove"
