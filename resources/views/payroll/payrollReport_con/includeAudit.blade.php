    ...
    <div class="modal-dialog box box-default" role="document">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="POST"
                action="{{ url('/audit-forward/payroll-report') }}">
                {{ csrf_field() }}
...
<div id="declineModal" class="modal fade">
    <div class="modal-dialog box box-default" role="document">
        <div class="modal-content">
            ...
            <form class="form-horizontal" role="form" method="POST" action="{{ url('/audit-decline/payroll-report') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="modal-body">
                    <div class="form-group" style="margin: 0 10px;">
                        <label class="control-label">Month</label>
                    ...
                    <!-- UPDATED - Attachment Upload Field (REQUIRED) -->
                   <div class="form-group" style="margin: 0 10px;">
                    ...
                    <!-- Comment History with Attachment Display -->
