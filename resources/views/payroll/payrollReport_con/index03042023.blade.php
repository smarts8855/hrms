                        ...
                        @if ($CourtInfo->divisionstatus == 1 && Auth::user()->is_global == 1)
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="division" id="division" class="form-control getDivision" style="font-size: 13px;">
                        ...
                        @else
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control getDivision" id="divisionName" name="divisionName"
