...
<div style = "clear:both"></div>
  ...
  <div class="box-body" style="background:#FFF;">
    ...
    <h4 class="col-md-6" style="text-transform:uppercase">Payroll Report</h4>
      ...
      <form method="post" action="{{ url('/new-payroll') }}" target="_blank">
      {{ csrf_field() }}
      <div class="col-md-12">
        <div class="row">
          ...
          <div class="col-md-6">
             ...
             <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select name="toYear" id="section" class="form-control" required>
                        <option value="">Select Year</option>
                        @for ($i = 2011; $i <= 2040; $i++)
                            <option value="{{ $i }}"
                                @if (old('toYear') == $i) selected @endif>{{ $i }}
                            </option>
                        @endfor
                    </select>
                </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                  ...
                  <select name="toMonth" id="section" class="form-control" required>
                      <option value="">Select Month </option>
                      <option value="JANUARY" @if (old('toMonth') == 'JANUARY') selected @endif>January
                      </option>
                      <option value="FEBRUARY" @if (old('toMonth') == 'FEBRUARY') selected @endif>February
                      </option>
                      <option value="MARCH" @if (old('toMonth') == 'MARCH') selected @endif>March</option>
                      <option value="APRIL" @if (old('toMonth') == 'APRIL') selected @endif>April</option>
                      <option value="MAY" @if (old('toMonth') == 'MAY') selected @endif>May</option>
                      <option value="JUNE" @if (old('toMonth') == 'JUNE') selected @endif>June</option>
                      <option value="JULY" @if (old('toMonth') == 'JULY') selected @endif>July</option>
                      <option value="AUGUST" @if (old('toMonth') == 'AUGUST') selected @endif>August
                      </option>
                      <option value="SEPTEMBER" @if (old('toMonth') == 'SEPTEMBER') selected @endif>September
                      </option>
                      <option value="OCTOBER" @if (old('toMonth') == 'OCTOBER') selected @endif>October
                      </option>
                      <option value="NOVEMBER" @if (old('toMonth') == 'NOVEMBER') selected @endif>November
                      </option>
                      <option value="DECEMBER" @if (old('toMonth') == 'DECEMBER') selected @endif>December
                      </option>
                  </select>
              </div>
          </div>
