...
<div class="box-body">
  <div>
    ...
    $earnvariation = (($basic + $peculiar + $peculiarFG + $leave + $driver + $utility + $servant + $furniture + $meal + $transport + $housing) * $months) +  (($basic + $peculiar + $peculiarFG + $leave + $driver + $utility + $servant + $furniture + $meal + $transport + $housing) * ($diff['days']/$diff['days_of_month']));
            ...
            <table class="table table-bordered table-condensed" align="right">
              <tr>
                ...
                <tr>
                  ...
                  <div align="left">Reason: <strong> </strong> <br/>
