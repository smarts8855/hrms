                        ...
                        <tr>
                            ...
                            <td colspan="2" width="300" style="border: 2px solid black !important">
                               ...
                               @if ($reports->employee_type == 2)
                                ...
                                @else
                                    <!-- CHANGE: Only show grade and step for employment_type 1, 3, and 4 -->
                                    @if ($reports->grade !== 1 && isset($reports->employment_type) && in_array($reports->employment_type, [1, 3, 4]))
                                        <span>Grade Level/Step:
                                            <strong>
                                                @if($reports->employment_type == 1)
                                                    GL{{ $reports->formattedGrade }}S{{ $reports->formattedStep }}
                                                @elseif($reports->employment_type == 3)
                                                    MS{{ $reports->formattedGrade }}S{{ $reports->formattedStep }}
                                                @elseif($reports->employment_type == 4)
                                                    DT{{ $reports->formattedGrade }}S{{ $reports->formattedStep }}
                                                @endif
                                            </strong>
                                        </span>
                                        <br />
                ...
                <table border="1"
                    ...
                    <tbody>
                        @php
                            ...
                            if (($reports->PEC != 0) || ($reports->PECFG != 0)) {
                                $earnings['PECULIAR'] = ($reports->PEC ?? 0) + ($reports->PECFG ?? 0);
                            }
                            if ($reports->SOT != 0) {
