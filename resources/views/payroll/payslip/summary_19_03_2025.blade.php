              ...
              <div class=" col-xs-5 border" style="height:250px;">
                            <div class="row">
                                ...
                                <div class="col-xs-6 text-right"><strong>
                                        {{ number_format($reports->Bs, 2, '.', ',') }}</strong> </div>
                            </div>

                            {{-- @if ($reports->grade == 1 && $reports->step == 1) --}}
                                @php
                                    //*****************SUMMING ALL OTHER EARNINGS ASIDE BASIC SALARY********************\\
                                    $sumOfOtherEarn = 0;
                                    ...
                                    //$totalSum = $specialOverture + $arearsEarning + $sumOfOtherEarning;
                                    $totalSum = $reports->AEarn + $reports->SOT + $sumOfOtherEarn + $reports->PEC;
                                    
                                    //****************SUMMING ALL OTHER EARNINGS ASIDE BASIC SALARY END********************\\
                                    
                                @endphp
                                <div class="row">
                                    <div class="col-xs-6 text-left"><strong>TOTAL ALLOWANCEEE</strong> </div>
                            ...
                            {{-- @else --}}
                                <div class="row">
                                    <div class="col-xs-6 text-left"><strong>PECULIAR</strong> </div>
                                    <div class="col-xs-6 text-right">
                                        <strong>{{ number_format($reports->PEC, 2, '.', ',') }}</strong>
                                    </div>
                                </div>
                                ...
                                @if ($reports->SOT != 0)
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6 text-right"><strong>
                                                {{ number_format($reports->SOT, 2, '.', ',') }}</strong> </div>
                                    </div>
                                @endif

                                <!--<div class="row">
                                                <div class="col-xs-6 text-left"><strong>TRANSPORT</strong> </div>
                                                <div class="col-xs-6 text-right"><strong> {{ number_format($reports->TR, 2, '.', ',') }}</strong> </div>
                                              </div>
                                              <div class="row">
                                ...
                                @if ($reports->AEarn != 0)
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6 text-right">
                                            <strong>{{ number_format($reports->AEarn, 2, '.', ',') }}
                                        </div>
                                    </div>
                                @endif
                                ...
                                @if (count($other_earn) > 0)
                                    @foreach ($other_earn as $list)
                                        <div class="row">
                                            <div class="col-xs-6 text-left" style="padding-right:0px;"><strong>
                                                    {{ strtoupper($list->description) }} </strong></div>
                                            <div class="col-xs-6 text-right"><strong>
                                                    {{ number_format($list->amount, 2, '.', ',') }}</strong></div>
                                        </div>
                                    @endforeach
                                @endif
                            {{-- @endif --}}
              ...
              <div class="col-xs-5 border lt" style="height:250px;">
                            ...
                            @if ($reports->grade == 1 && $reports->step == 1)
                                <div class="row">
                                    ...
                                    <div class="col-xs-6 text-right">
                                        <strong>{{ number_format($reports->TAX, 2, '.', ',') }}</strong>
                                    </div>
                                </div>
                                <div class="row">
                                  <div class="col-xs-6 text-left"><strong>NHF</strong></div>
                                  <div class="col-xs-6 text-right">
                                      <strong>{{ number_format($reports->NHF, 2, '.', ',') }}</strong>
                                  </div>
                                </div>
                            ...
                            @else
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6 text-right">
                                        <strong>{{ number_format($reports->PEN, 2, '.', ',') }}</strong>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xs-6 text-left"><strong>NHF</strong></div>
                                ...
                                @if ($reports->UD != 0)
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6 text-right"><strong>
                                                {{ number_format($reports->UD, 2, '.', ',') }}</strong></div>
                                    </div>
                                @endif
                                @if ($reports->AD != 0)
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6 text-right">
                                            <strong>{{ number_format($reports->AD, 2, '.', ',') }}
                                        </div>
                                    </div>
                                @endif
                                @if (count($other_deduct) > 0)
