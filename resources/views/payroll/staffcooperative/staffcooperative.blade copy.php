            ...
            <div class="box">
                ...
                <div class="print-view" style="display: none;">
                    <div class="print-header" style="text-align: center; margin-bottom: 20px;">
                        {{-- <h2 style="margin-bottom: 5px;"><strong>STAFF EARNING AND DEDUCTION</strong></h2> --}}
                        ...
                        {{-- <p style="margin-bottom: 20px;">
                            ...
                            @php
                                $type = '';
                                if(isset($EorDSession[0])) {
                                    $type = $EorDSession[0]->particularID == 1 ? 'EARNING' : 'DEDUCTION';
                                } elseif(isset($earnordeduction)) {
                                    $type = $earnordeduction == 'earn' ? 'EARNING' : 'DEDUCTION';
                                }
                            @endphp
                            @if($type)
                                Type: {{ $type }}
                    ...
                    {{-- <div style="margin-top: 50px; page-break-inside: avoid;">
                        <div style="width: 100%; border-top: 1px solid #000; padding-top: 20px;">
                            <div style="width: 45%; float: left;">
                                <p style="margin-bottom: 5px;"><strong>Prepared By:</strong></p>
                                <p style="margin-bottom: 20px; margin-top: 30px;">_______________________</p>
                                <p style="margin-bottom: 5px;">Name</p>
                                <p style="margin-bottom: 5px;">Signature</p>
                                <p style="margin-bottom: 5px;">Date</p>
                            </div>
                            <div style="width: 45%; float: right;">
                                <p style="margin-bottom: 5px; text-align: right;"><strong>Approved By:</strong></p>
                                <p style="margin-bottom: 20px; margin-top: 30px; text-align: right;">_______________________</p>
                                <p style="margin-bottom: 5px; text-align: right;">Name</p>
                                <p style="margin-bottom: 5px; text-align: right;">Signature</p>
                                <p style="margin-bottom: 5px; text-align: right;">Date</p>
                            </div>
