...
@endsection
@section('content')
    <form method="post" action="{{ url('scn-payroll/summary/bank-mandate') }}">
        <div class="box-body" style="background:#FFF;">
            <div class="row">
                ...
                <div class="col-md-12">
                     ...
                     <div align="left">
                        <strong>PAYROLL SUMMARY BANK MANDATE ANALYSIS</strong>
                    </div>
                    <br />
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="bank" id="section" class="form-control" required>
                                    ...
                                    <option value="CBN" @if (old('bank') == 'CBN') selected @endif>CENTRAL BANK (NHF,NSITF, TAX)
                                    </option>
                                    <option value="COMMERCIAL" @if (old('bank') == 'COMMERCIAL') selected @endif>COMMERCIAL BANK(NETPAY)
                                    </option>
                                    <option value="Micro_Finance" @if (old('bank') == 'Micro_Finance') selected @endif>MICRO FINANCE BANK(NETPAY) </option>

                                    <option value="NASARAWA" @if (old('bank') == 'NASARAWA') selected @endif>FIRST BANK(NASARAWA TAX) </option>
                                    <option value="NIGER" @if (old('bank') == 'NIGER') selected @endif>FIRST BANK(NIGER TAX) </option>
                                    <option value="UNION_DUES" @if (old('bank') == 'UNION_DUES') selected @endif>FIRST BANK (UNION DUES) </option>
