...
@section('content')
  <form method="post" action="{{ url('/treasury209/view-council') }}">
			...
			{{ csrf_field() }}
				...
				<div class="col-md-12"><!--2nd col-->
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label for="bank">Select Division</label>
								<select name="division" class="form-control">
									<option selected value="">-All Division-</option>
									@foreach($allDivisions as $list)
										<option @if (old('division') == $list->divisionID) {{ 'selected' }} @endif value="{{$list->divisionID}}">{{$list->division}}</option>
									@endforeach
								</select>
							</div>
						</div>
