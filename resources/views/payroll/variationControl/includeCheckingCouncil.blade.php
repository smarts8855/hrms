    ...
    <div class="modal-dialog box box-default" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Please confirm that you want to forward to the next unit </h4>
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST"
                    action="{{ url('/checking-forward-council/payroll-report') }}">
                    {{ csrf_field() }}
...
<div id="declineModal" class="modal fade">
    <div class="modal-dialog box box-default" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST"
                    action="{{ url('/checking-decline-council/payroll-report') }}">
                    {{ csrf_field() }}
                    <div class="form-group" style="margin: 0 10px;">
                        <label class="control-label">Month</label>
...
<div class="">
    ...
    @else
        <button class="btn btn-success" type="button" id="push"
            data-vstage="{{ $payroll_detail[0]->vstage }}" data-year="{{ $payroll_detail[0]->year }}"
            data-month="{{ $payroll_detail[0]->month }}" data-division="{{ $payroll_detail[0]->division }}"
