                ...
                <form id="contractForm" class="custom-validation formFormatAmount" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <!-- Display existing files in edit mode with unique codes -->
            ...
            <div class="checkbox" style="margin: 8px 0; padding-left: 20px;">
                <label style="font-weight: normal;">
                    ...
                    <a href="{{ $doc->file_path }}" target="_blank" class="text-primary" style="margin-left: 5px;">
                        ...
                        <span style="font-family: monospace; color: #0066cc;">
                            {{ $doc->file_name }}
                        </span>
                    </a>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
          ...
          // Function to display memoir files with unique codes
            function displayMemoirFiles(files) {
                ...
                if (files && files.length > 0) {
                    files.forEach(function(file, index) {
                        ...
                        // Simply display the full filename - no parsing needed!
                        var fileItem = `
                            <div class="list-group-item file-item" data-file-id="${file.id}">
                                <div class="row">
                                    <div class="col-xs-8">
                                        ...
                                        <a href="${file.file_path}" target="_blank" title="Click to download">
                                            <span style="font-family: monospace; background-color: #e8f4fd; padding: 2px 5px; border-radius: 3px;">
                                                ${file.file_name}
                                            </span>
                                        </a>
                                        <br>
