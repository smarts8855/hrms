                                            ...
                                            <select class="form-control" name="contract" disabled>
                                                ...
                                                @foreach ($contract as $list)
                                                    <option value="{{ $list->contract_detailsID }}"
                                                        @if ($edit->contract_detailsID == $list->contract_detailsID) selected @endif>
                                                        {{ $list->contract_name }}{{ $list->contract_detailsID }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            ...
                                            <select class="form-control" name="contractor" disabled>
                                                ...
                                                @foreach ($contractor as $list)
                                                    <option value="{{ $list->contractor_registrationID }}"
                                                        @if ($edit->contractorID == $list->contractor_registrationID) selected @endif>
                                                        {{ $list->company_name }}
                                                    </option>
                                                @endforeach
                                            </select>
