...
@section('content')
    ...
    @if (count($datas) > 0)
        <div class="text-center">
            ...
            <a href="{{ '/contracts-coments/' . base64_encode($datas[0]->contract_detailsID) }}" target="_blank"><button
        ...
        @if ($files == null)
        @else
            <a href="{{ asset('images/' . $files->file_name) }}" target="_blank"><button class="btn btn-success btn-sm"
        ...
        <div class="row">
            ...
            <div class="col-12" style="padding: 10px">
                <div class="panel panel-default" style="border-radius:6px; box-shadow:0 0 5px rgba(0,0,0,0.1);">
                                    ...
                                    <tr data-stat={{ $data->status }} data-recommendation="{{ $data->recommendation }}">
                                        ...
                                        <td>
                                            ...
                                            <a href={{ '#contract' . $data->contract_biddingID }}
                                                data-target="{{ '#file' . $data->contract_biddingID }}" data-toggle="modal"
                                                aria-expanded="false" aria-controls="multiCollapseExample1"
                                                class="{{ $data->recommendation == 1 ? 'text-white' : '' }}">view all</a>
                                        </td>

                                        <div class="modal fade" id={{ 'file' . $data->contract_biddingID }} tabindex="-1"
                                            role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Bidding Documents
                                                        </h5>
                                                    ...
                                                    <div class="modal-body">
                                                        @foreach ($data->documents as $key => $document)
                                                            <a href="{{ asset('BiddingDocument/' . $document->bidDocument) }}"
                                            ...
                                            @if (
                                                ...
                                                @if ($data->status == 0)
                                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                                        data-target={{ '#requalify' . $data->contract_biddingID }}><i
                                                            class="fa fa-check"></i>
                                                        Requalify
                                                    </button>
                                                @else
                                                    @if ($data->recommendation == 0)
                                                        <button type="button"
                                                            class="btn btn-danger btn-sm"style="margin-bottom:5px;"
                                                            data-toggle="modal"
                                                ...
                                                @if ($data->status == 0)
                                                    ...
                                                    @else
                                                        <div class="modal fade"
                                                            id={{ 'disqualify' . $data->contract_biddingID }}
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            @if ($data->status == 0)
                                                                <p style="color:grey;">Please give a reason for your
                                                            ...
                                                            <div class="row col-12">
                                                                <label class="form-check-label" for="disqualifyComment"
                                                                    style="color:grey">Reason</label>
                                                                <textarea name="disqualifyComment" class="form-control" id="disqualifyComment"></textarea>
                                                            </div>

                                                            <div class="form-group">
                                                                <textarea style="visibility:hidden" name="comment" id="other-field" class="form-control other-field"
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            @if ($data->status == 0)
                                                                <button type="submit" class="btn btn-success">Requalify
                                                                    Contract</button>
                                                            @else
                                                                <button type="submit" class="btn btn-danger"
                                                                    id="disqualifyButton" disabled>Disqualify
                                                                    Contract</button>
                                                            @endif
                                                            </form>
                                                        </div>
                    ...
                    @if ($data->recommendation == 0)
                        <button class="btn btn-sm btn-primary recommend_option" style="margin-bottom:5px;"
                                    ...
                                    <form method="POST"
                                        ...
                                        <div class="form-group">
                                            <input type="hidden" class="form-control"
                                                value={{ $data->contract_biddingID }} name="biddingID">
                                        </div>
...
@else
    ...
    @php
        // Helper function to check if any element in the array has recommended == 1
        $hasRecommended = function ($datas) {
            foreach ($datas as $data) {
    ...
    @endphp
    @if ($datas[0]->current_location < 2 && $contract->status == 1 && $hasRecommended($datas))
        <div class="row">

            {{-- @if ($contract->closed_bidding == 1) --}}

            {{-- <button style="margin-left:13px;" data-toggle="modal" data-target="#secretary" id="to_secretary"
                class="btn btn-success">Move to Accounting Officer</button>
            <button id="to_tenders" class="btn btn-success btn-warning" data-toggle="modal" data-target="#tenders">Move
                to Tenders Board</button>
            <button id="to_tenders" class="btn btn-primary" data-toggle="modal" data-target="#f_tenders">Move To Federal
                Judiciary Tenders Board</button>
            ...
            {{-- <div class="btn-group" style="margin-left:13px;">
                <button data-toggle="modal" data-target="#secretary" id="to_secretary" class="btn btn-success btn-sm">
                    Move to Accounting Officer
                </button>

                <button id="to_tenders" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#tenders">
                    Move to Tenders Board
                </button>

                <button id="to_f_tenders" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#f_tenders">
                    Move To Federal Judiciary Tenders Board
                </button>
            ...
            @php
                $amount = $datas[0]->bidding_amount;
            @endphp

            <div style="margin-left:13px;">

                {{-- CR Button: 100 million and above --}}
                {{-- @if ($amount >= 100000000) --}}
                    <button data-toggle="modal" data-target="#secretary" id="to_secretary"
                        class="btn btn-success btn-sm" style="margin-right:10px; border-radius:6px;">
                        Move to Chief Registrar
                    </button>
                {{-- @endif --}}

                {{-- Tenders Board: 51 million to 99 million --}}
                {{-- @if ($amount >= 51000000 && $amount <= 99999999) --}}
                    <button id="to_tenders" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#tenders"
                        style="margin-right:10px; border-radius:6px;">
                        Move to Tenders Board
                    </button>
                ...
                {{-- Judiciary Tender Board: 50 million down --}}
                {{-- @if ($amount <= 50000000) --}}
                    <button id="to_f_tenders" class="btn btn-primary btn-sm" data-toggle="modal"
                        data-target="#f_tenders" style="margin-right:10px; border-radius:6px;">
                        Move To Federal Judiciary Tenders Board
                    </button>
                {{-- @endif --}}

                {{-- Cancel Bids: Always visible --}}
                <button id="block" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#blocks"
                    style="border-radius:6px;">
                    Cancel Bids
                </button>
            ...
            <div class="modal fade" id="secretary" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Move to Chief Registrar</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            ...
                            <form method="POST" action="/pro-procurement/approve/{{ $datas[0]->contractID }}"
            ...
            <div class="modal fade" id="tenders" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            ...
                            <form method="POST" action="/pro-procurement/to-tenders/{{ $datas[0]->contractID }}"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
            ...
            <div class="modal fade" id="f_tenders" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            ...
                            <form method="POST" action="/pro-procurement/to-f-tenders/{{ $datas[0]->contractID }}"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <textarea name="comment" class="form-control" placeholder="reason"></textarea>
            ...
            <div class="modal fade" id="blocks" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
...
@else
    ...
    <a href="{{ '/contract-comments/' . encrypt($contract->contract_detailsID) }}"><button class="btn btn-success btn-sm"
            style="margin-left:14px; margin-top:-20px; margin-bottom:50px">View Minutes</button></a>
    <a href="{{ '/requalify-bids/' . encrypt($contract->contract_detailsID) }}"><button class="btn btn-success btn-sm"
            style="margin-left:14px; margin-top:-20px; margin-bottom:50px">Disqualified Bids</button></a>
    @if ($files == null)
    @else
        <a href="{{ asset('images/' . $files->file_name) }}" target="_blank"><button class="btn btn-success btn-sm"
...
@section('scripts')
    <script type="text/javascript">
        ...
        $(recommended).css("background-color", "rgba(28,187,140,25)");
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const textarea = document.getElementById('disqualifyComment');
            const submitButton = document.getElementById('disqualifyButton');
