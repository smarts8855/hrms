...
@section('pageTitle', 'Technical Evaluation')
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading clearfix">
                        <div class="pull-left">
                            <h3 class="panel-title"><b>Technical Evaluation</b></h3>
                        </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <h5 class="panel-title mb-3">
                                    <i class="fa fa-search mr-2"></i> Search Contracts
                                </h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @elseif($data->location == 5)
                                                    <span class="label label-warning">Federal Judicial Tender's
                                                        Board</span>
                                                @else
                                                    <span class="label label-default">Secretary</span>
                                                @endif
                                            </td>
                                            <td>
                                                @if ($data->status == 4)
                                            ...
                                            <td>
                                                <a class="btn btn-info btn-xs"
                                                    href="{{ '/pro-procurement/tech-evaluate/' . encrypt($data->contract_detailsID) }}">
                            ...
                            @if ($datas->count() == 0)
                                <div class="text-center py-5">
                                    <div class="text-muted">
                                        ...
                                        <p>No contracts available for technical evaluation.</p>
                                    </div>
                                </div>
                            @endif
                        </div>
