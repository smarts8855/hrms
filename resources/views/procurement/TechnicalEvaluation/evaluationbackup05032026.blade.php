        ...
        <div class="text-center">
            <h3 style="margin-left:14px; margin-bottom:30px; font-weight:bold">Lot No: <span
                ...
                <a href="{{ '/contracts-coments/' . base64_encode($datas[0]->contract_detailsID) }}" target="_blank"><button
                        class="btn btn-success btn-sm" style="margin-left:14px; margin-top:5px; margin-bottom:50px">View
                        Minutes</button></a>
...
@else
    <h3 style="margin-left:14px; margin-bottom:30px; font-weight:bold">Lot No: <span
        ...
        <a href="{{ '/requalify-bids/' . encrypt($contract->contract_detailsID) }}"><button
                class="btn btn-success btn-sm" style="margin-left:14px; margin-top:5px; margin-bottom:50px">Disqualified
                Bids</button></a>
        @if ($files == null)
        @else
            <a href="{{ asset('images/' . $files->file_name) }}" target="_blank"><button class="btn btn-success btn-sm"
