                        ...
                        <tr>
                          ...
                          @if($ifApproved > 0)
                           ...
                           <input type="submit" name="submit" class="btn btn-success float-right approve" id="{{$contractID}}" value="Reverse">
                            ...
                            <input type="submit" name="submit" class="btn btn-success float-right reject" id="{{$contractID}}" value="Reject">
                         @endif
...
<div id="approveModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3>Reason For Reversal</h3>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                
                <p id="message"></p>
            </div>
            <form method="post" action="{{url('/contract-approval/reversal')}}">
                {{ csrf_field() }}
            <div class="modal-body">
