                            ...
                            <tbody>
                                @forelse ($requests as $key => $row)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($row->status == 1)
                                                <a href="{{ route('submitted-item-request-view', $row->id) }}"
                                                    class="btn btn-primary btn-xs">
                                                    <i class="fa fa-eye"></i> View / Recommend
                                                </a>
                                            @else
                                                <button type="button"
                                                    class="btn btn-success btn-xs open-request-modal btn-block"
                            ...
                            <thead style="background: #f5f5f5;">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 15%;" id="modal-action-th">Action</th>
                                    </tr>
                                </thead>
                            </thead>
