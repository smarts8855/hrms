...
@section('pageTitle')
    {{ strtoupper('Items Summary Report') }}
@endsection
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-heading clearfix">
                        <h4 class="panel-title pull-left">
                            <i class="fas fa-boxes"></i> Items Summary Report
                        </h4>
                    ...
                    <div id="filters" class="panel-collapse collapse">
                        <div class="panel-body">
                            <form action="{{ route('reports.items_summary') }}" method="GET">
                                <div class="row">
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            <label>Search</label>
                                            <input type="text" name="search" class="form-control"
                                                value="{{ request('search') }}" placeholder="Item name or specification...">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        ...
                                        <a href="{{ route('reports.items_summary') }}" class="btn btn-default btn-sm">
                                ...
                                <tbody>
                                    @forelse($items as $index => $item)
                                        <tr>
                                            ...
                                            <td class="{{ $item->total_quantity <= 0 ? 'text-danger' : '' }}">
                                                {{ $item->total_quantity }}
                                            </td>
                                        </tr>
                                    @empty
